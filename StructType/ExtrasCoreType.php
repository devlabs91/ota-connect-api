...
class ExtrasCoreType extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\SubCategory[]
     */
    public $SubCategory;
    /**
     * The RPH
     ...
     * @param \OtaInterface\Otaconnect\StructType\SubCategory[] $subCategory
     * @param string $rPH
     * @param string $code
     * @param string $type
     ...
     * @return \OtaInterface\Otaconnect\StructType\SubCategory[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\SubCategory[] $subCategory
     * @return \OtaInterface\Otaconnect\StructType\ExtrasCoreType
     */
    public function setSubCategory(array $subCategory = array())
    {
        foreach ($subCategory as $extrasCoreTypeSubCategoryItem) {
            // validation for constraint: itemType
            if (!$extrasCoreTypeSubCategoryItem instanceof \OtaInterface\Otaconnect\StructType\SubCategory) {
                throw new \InvalidArgumentException(sprintf('The SubCategory property can only contain items of \OtaInterface\Otaconnect\StructType\SubCategory, "%s" given', is_object($extrasCoreTypeSubCategoryItem) ? get_class($extrasCoreTypeSubCategoryItem) : gettype($extrasCoreTypeSubCategoryItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\SubCategory $item
     * @return \OtaInterface\Otaconnect\StructType\ExtrasCoreType
     */
    public function addToSubCategory(\OtaInterface\Otaconnect\StructType\SubCategory $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\SubCategory) {
            throw new \InvalidArgumentException(sprintf('The SubCategory property can only contain items of \OtaInterface\Otaconnect\StructType\SubCategory, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
