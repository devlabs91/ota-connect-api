...
class ItineraryItemRequestType extends AbstractStructBase
{
     ...
     * @param string $rPH
     */
    public function __construct($accommodation = null, $flight = null, \OtaInterface\Otaconnect\StructType\RentalCar $rentalCar = null, $rPH = null)
    {
        $this
     ...
     * @param mixed $accommodation
     * @return \OtaInterface\Otaconnect\StructType\ItineraryItemRequestType
     */
