...
class OrganizationType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\OrgMemberName
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\OrgMemberName $orgMemberName
     * @param mixed $orgName
     * @param mixed[] $relatedOrgName
     * @param mixed[] $travelArranger
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\OrgMemberName $orgMemberName = null, $orgName = null, array $relatedOrgName = array(), array $travelArranger = array())
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\OrgMemberName|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\OrgMemberName $orgMemberName
     * @return \OtaInterface\Otaconnect\StructType\OrganizationType
     */
    public function setOrgMemberName(\OtaInterface\Otaconnect\StructType\OrgMemberName $orgMemberName = null)
    {
