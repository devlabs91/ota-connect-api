...
class ContactPersonType extends AbstractStructBase
{
     ...
     * @param mixed $personName
     * @return \OtaInterface\Otaconnect\StructType\ContactPersonType
     */
    ...
    public function setTelephone(array $telephone = array())
    {
        foreach ($telephone as $contactPersonTypeTelephoneItem) {
            ...
            if (!$contactPersonTypeTelephoneItem instanceof \OtaInterface\Otaconnect\StructType\Telephone) {
                throw new \InvalidArgumentException(sprintf('The Telephone property can only contain items of \OtaInterface\Otaconnect\StructType\Telephone, "%s" given', is_object($contactPersonTypeTelephoneItem) ? get_class($contactPersonTypeTelephoneItem) : gettype($contactPersonTypeTelephoneItem)), __LINE__);
            }
        }
