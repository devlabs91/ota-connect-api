...
class FareCodeOptionType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\FareRemark
     */
    public $FareRemark;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\FareRemark $fareRemark
     * @param string $listOfFareQualifierCode
     * @param string $status
     * @param string $fareDescription
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\FareRemark $fareRemark = null, $listOfFareQualifierCode = null, $status = null, $fareDescription = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\FareRemark|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\FareRemark $fareRemark
     * @return \OtaInterface\Otaconnect\StructType\FareCodeOptionType
     */
    public function setFareRemark(\OtaInterface\Otaconnect\StructType\FareRemark $fareRemark = null)
    {
