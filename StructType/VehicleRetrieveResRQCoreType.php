...
class VehicleRetrieveResRQCoreType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PersonNameType
     */
    public $PersonName;
    /**
     * The CustLoyalty
     ...
     * @param \OtaInterface\Otaconnect\StructType\PersonNameType $personName
     * @param \OtaInterface\Otaconnect\StructType\CustLoyalty $custLoyalty
     * @param mixed $tPA_Extensions
     */
    public function __construct(array $uniqueID = array(), \OtaInterface\Otaconnect\StructType\PersonNameType $personName = null, \OtaInterface\Otaconnect\StructType\CustLoyalty $custLoyalty = null, $tPA_Extensions = null)
    {
        $this
     ...
     * @param \OtaInterface\Otaconnect\StructType\UniqueID_Type[] $uniqueID
     * @return \OtaInterface\Otaconnect\StructType\VehicleRetrieveResRQCoreType
     */
    public function setUniqueID(array $uniqueID = array())
    {
        foreach ($uniqueID as $vehicleRetrieveResRQCoreTypeUniqueIDItem) {
            // validation for constraint: itemType
            if (!$vehicleRetrieveResRQCoreTypeUniqueIDItem instanceof \OtaInterface\Otaconnect\StructType\UniqueID_Type) {
                throw new \InvalidArgumentException(sprintf('The UniqueID property can only contain items of \OtaInterface\Otaconnect\StructType\UniqueID_Type, "%s" given', is_object($vehicleRetrieveResRQCoreTypeUniqueIDItem) ? get_class($vehicleRetrieveResRQCoreTypeUniqueIDItem) : gettype($vehicleRetrieveResRQCoreTypeUniqueIDItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\UniqueID_Type $item
     * @return \OtaInterface\Otaconnect\StructType\VehicleRetrieveResRQCoreType
     */
    public function addToUniqueID(\OtaInterface\Otaconnect\StructType\UniqueID_Type $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\UniqueID_Type) {
            throw new \InvalidArgumentException(sprintf('The UniqueID property can only contain items of \OtaInterface\Otaconnect\StructType\UniqueID_Type, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->UniqueID[] = $item;
        return $this;
    }
     ...
     * @return \OtaInterface\Otaconnect\StructType\PersonNameType|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\VehicleRetrieveResRQCoreType
     */
    public function setPersonName(\OtaInterface\Otaconnect\StructType\PersonNameType $personName = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\VehicleRetrieveResRQCoreType
     */
    public function setCustLoyalty(\OtaInterface\Otaconnect\StructType\CustLoyalty $custLoyalty = null)
    {
