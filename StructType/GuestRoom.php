...
class GuestRoom extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\TypeRoom[]
     */
    public $TypeRoom;
    /**
     * The Amenities
     ...
     * @param \OtaInterface\Otaconnect\StructType\TypeRoom[] $typeRoom
    ...
    /**
     * Get TypeRoom value
     * @return \OtaInterface\Otaconnect\StructType\TypeRoom[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\TypeRoom[] $typeRoom
     * @return \OtaInterface\Otaconnect\StructType\GuestRoom
     */
    public function setTypeRoom(array $typeRoom = array())
    {
        foreach ($typeRoom as $guestRoomTypeRoomItem) {
            // validation for constraint: itemType
            if (!$guestRoomTypeRoomItem instanceof \OtaInterface\Otaconnect\StructType\TypeRoom) {
                throw new \InvalidArgumentException(sprintf('The TypeRoom property can only contain items of \OtaInterface\Otaconnect\StructType\TypeRoom, "%s" given', is_object($guestRoomTypeRoomItem) ? get_class($guestRoomTypeRoomItem) : gettype($guestRoomTypeRoomItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\TypeRoom $item
     * @return \OtaInterface\Otaconnect\StructType\GuestRoom
     */
    public function addToTypeRoom(\OtaInterface\Otaconnect\StructType\TypeRoom $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\TypeRoom) {
            throw new \InvalidArgumentException(sprintf('The TypeRoom property can only contain items of \OtaInterface\Otaconnect\StructType\TypeRoom, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->TypeRoom[] = $item;
        return $this;
    }
