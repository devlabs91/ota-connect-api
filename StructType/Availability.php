...
class Availability extends AbstractStructBase
{
    ...
    /**
     * Set Status value
     * @uses \OtaInterface\Otaconnect\EnumType\AvailabilityStatusType::valueIsValid()
     * @uses \OtaInterface\Otaconnect\EnumType\AvailabilityStatusType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $status
     * @return \OtaInterface\Otaconnect\StructType\Availability
     */
    public function setStatus($status = null)
    {
        // validation for constraint: enumeration
        if (!\OtaInterface\Otaconnect\EnumType\AvailabilityStatusType::valueIsValid($status)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $status, implode(', ', \OtaInterface\Otaconnect\EnumType\AvailabilityStatusType::getValidValues())), __LINE__);
        }
        $this->Status = $status;
        return $this;
    }
    ...
    public function setRestriction(array $restriction = array())
    {
        ...
        foreach ($restriction as $availabilityRestrictionItem) {
            if (!\OtaInterface\Otaconnect\EnumType\Restriction::valueIsValid($availabilityRestrictionItem)) {
