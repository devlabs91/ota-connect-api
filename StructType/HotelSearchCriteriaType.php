...
class HotelSearchCriteriaType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: unbounded
     * @var \OtaInterface\Otaconnect\StructType\Criterion[]
     */
    public $Criterion;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\Criterion[] $criterion
    ...
    /**
     * Get Criterion value
     * @return \OtaInterface\Otaconnect\StructType\Criterion[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Criterion[] $criterion
     * @return \OtaInterface\Otaconnect\StructType\HotelSearchCriteriaType
     */
    public function setCriterion(array $criterion = array())
    {
        foreach ($criterion as $hotelSearchCriteriaTypeCriterionItem) {
            // validation for constraint: itemType
            if (!$hotelSearchCriteriaTypeCriterionItem instanceof \OtaInterface\Otaconnect\StructType\Criterion) {
                throw new \InvalidArgumentException(sprintf('The Criterion property can only contain items of \OtaInterface\Otaconnect\StructType\Criterion, "%s" given', is_object($hotelSearchCriteriaTypeCriterionItem) ? get_class($hotelSearchCriteriaTypeCriterionItem) : gettype($hotelSearchCriteriaTypeCriterionItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Criterion $item
     * @return \OtaInterface\Otaconnect\StructType\HotelSearchCriteriaType
     */
    public function addToCriterion(\OtaInterface\Otaconnect\StructType\Criterion $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Criterion) {
            throw new \InvalidArgumentException(sprintf('The Criterion property can only contain items of \OtaInterface\Otaconnect\StructType\Criterion, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Criterion[] = $item;
        return $this;
    }
