...
class Descriptions extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Renovation[]
     */
    public $Renovation;
    /**
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\MultimediaDescriptions
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Renovation[] $renovation
     * @param \OtaInterface\Otaconnect\StructType\MultimediaDescriptions $multimediaDescriptions
     * @param string $descriptiveText
     */
    public function __construct(array $description = array(), array $renovation = array(), \OtaInterface\Otaconnect\StructType\MultimediaDescriptions $multimediaDescriptions = null, $descriptiveText = null)
    {
        $this
     ...
     * @param mixed[] $description
     * @return \OtaInterface\Otaconnect\StructType\Descriptions
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Renovation[]|null
     */
    ...
    public function setRenovation(array $renovation = array())
    {
        foreach ($renovation as $descriptionsRenovationItem) {
            // validation for constraint: itemType
            if (!$descriptionsRenovationItem instanceof \OtaInterface\Otaconnect\StructType\Renovation) {
                throw new \InvalidArgumentException(sprintf('The Renovation property can only contain items of \OtaInterface\Otaconnect\StructType\Renovation, "%s" given', is_object($descriptionsRenovationItem) ? get_class($descriptionsRenovationItem) : gettype($descriptionsRenovationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Renovation $item
     * @return \OtaInterface\Otaconnect\StructType\Descriptions
     */
    public function addToRenovation(\OtaInterface\Otaconnect\StructType\Renovation $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Renovation) {
            throw new \InvalidArgumentException(sprintf('The Renovation property can only contain items of \OtaInterface\Otaconnect\StructType\Renovation, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\MultimediaDescriptions|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Descriptions
     */
    public function setMultimediaDescriptions(\OtaInterface\Otaconnect\StructType\MultimediaDescriptions $multimediaDescriptions = null)
    {
