...
class RoomStays extends AbstractStructBase
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\RoomStay[] $roomStay
     * @return \OtaInterface\Otaconnect\StructType\RoomStays
     */
    public function setRoomStay(array $roomStay = array())
    {
        foreach ($roomStay as $roomStaysRoomStayItem) {
            // validation for constraint: itemType
            if (!$roomStaysRoomStayItem instanceof \OtaInterface\Otaconnect\StructType\RoomStay) {
                throw new \InvalidArgumentException(sprintf('The RoomStay property can only contain items of \OtaInterface\Otaconnect\StructType\RoomStay, "%s" given', is_object($roomStaysRoomStayItem) ? get_class($roomStaysRoomStayItem) : gettype($roomStaysRoomStayItem)), __LINE__);
            }
        }
