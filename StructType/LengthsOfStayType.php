...
class LengthsOfStayType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\LengthOfStay[]
     */
    public $LengthOfStay;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\LengthOfStay[] $lengthOfStay
     ...
     * @return \OtaInterface\Otaconnect\StructType\LengthOfStay[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LengthOfStay[] $lengthOfStay
     * @return \OtaInterface\Otaconnect\StructType\LengthsOfStayType
     */
    public function setLengthOfStay(array $lengthOfStay = array())
    {
        foreach ($lengthOfStay as $lengthsOfStayTypeLengthOfStayItem) {
            // validation for constraint: itemType
            if (!$lengthsOfStayTypeLengthOfStayItem instanceof \OtaInterface\Otaconnect\StructType\LengthOfStay) {
                throw new \InvalidArgumentException(sprintf('The LengthOfStay property can only contain items of \OtaInterface\Otaconnect\StructType\LengthOfStay, "%s" given', is_object($lengthsOfStayTypeLengthOfStayItem) ? get_class($lengthsOfStayTypeLengthOfStayItem) : gettype($lengthsOfStayTypeLengthOfStayItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\LengthOfStay $item
     * @return \OtaInterface\Otaconnect\StructType\LengthsOfStayType
     */
    public function addToLengthOfStay(\OtaInterface\Otaconnect\StructType\LengthOfStay $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\LengthOfStay) {
            throw new \InvalidArgumentException(sprintf('The LengthOfStay property can only contain items of \OtaInterface\Otaconnect\StructType\LengthOfStay, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
