...
class Accommodation extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AccommodationClass
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\RoomProfiles
     */
    public $RoomProfiles;
    /**
     * The MealPlans
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\MealPlans
     */
    public $MealPlans;
    /**
     * The RPH
     ...
     * @param \OtaInterface\Otaconnect\StructType\AccommodationClass $accommodationClass
     * @param mixed $dateRange
     * @param \OtaInterface\Otaconnect\StructType\RoomProfiles $roomProfiles
     * @param \OtaInterface\Otaconnect\StructType\MealPlans $mealPlans
     * @param string $rPH
     * @param string $resortName
     * @param string $resortCode
     */
    public function __construct($identity = null, \OtaInterface\Otaconnect\StructType\AccommodationClass $accommodationClass = null, $dateRange = null, \OtaInterface\Otaconnect\StructType\RoomProfiles $roomProfiles = null, \OtaInterface\Otaconnect\StructType\MealPlans $mealPlans = null, $rPH = null, $resortName = null, $resortCode = null)
    {
        $this
     ...
     * Set Identity value
     * @param mixed $identity
     * @return \OtaInterface\Otaconnect\StructType\Accommodation
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AccommodationClass|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Accommodation
     */
    public function setAccommodationClass(\OtaInterface\Otaconnect\StructType\AccommodationClass $accommodationClass = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\RoomProfiles|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Accommodation
     */
    public function setRoomProfiles(\OtaInterface\Otaconnect\StructType\RoomProfiles $roomProfiles = null)
    {
    ...
    /**
     * Get MealPlans value
     * @return \OtaInterface\Otaconnect\StructType\MealPlans|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Accommodation
     */
    public function setMealPlans(\OtaInterface\Otaconnect\StructType\MealPlans $mealPlans = null)
    {
