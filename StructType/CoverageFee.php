...
class CoverageFee extends AbstractStructBase
{
     ...
     */
    public function __construct($charge = null, \OtaInterface\Otaconnect\StructType\Vehicles $vehicles = null, $deductible = null)
    {
        $this
            ->setCharge($charge)
     ...
     * Set Charge value
     * @param mixed $charge
     * @return \OtaInterface\Otaconnect\StructType\CoverageFee
     */
