...
class CabinOptionType extends AbstractStructBase
{
     ...
     * - maxOccurs: 9
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\CabinConfiguration[]
     */
     ...
     * - maxOccurs: 9
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\MeasurementInfo[]
     */
     ...
     * @param string $status
     * @param \OtaInterface\Otaconnect\StructType\CabinConfiguration[] $cabinConfiguration
     * @param \OtaInterface\Otaconnect\StructType\MeasurementInfo[] $measurementInfo
     * @param mixed $remark
     ...
     * Set Status value
     * @param string $status
     * @return \OtaInterface\Otaconnect\StructType\CabinOptionType
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\CabinConfiguration[]|null
     */
    ...
    public function setCabinConfiguration(array $cabinConfiguration = array())
    {
        foreach ($cabinConfiguration as $cabinOptionTypeCabinConfigurationItem) {
            ...
            if (!$cabinOptionTypeCabinConfigurationItem instanceof \OtaInterface\Otaconnect\StructType\CabinConfiguration) {
                throw new \InvalidArgumentException(sprintf('The CabinConfiguration property can only contain items of \OtaInterface\Otaconnect\StructType\CabinConfiguration, "%s" given', is_object($cabinOptionTypeCabinConfigurationItem) ? get_class($cabinOptionTypeCabinConfigurationItem) : gettype($cabinOptionTypeCabinConfigurationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\CabinConfiguration $item
     * @return \OtaInterface\Otaconnect\StructType\CabinOptionType
     */
    public function addToCabinConfiguration(\OtaInterface\Otaconnect\StructType\CabinConfiguration $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\CabinConfiguration) {
            throw new \InvalidArgumentException(sprintf('The CabinConfiguration property can only contain items of \OtaInterface\Otaconnect\StructType\CabinConfiguration, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\MeasurementInfo[]|null
     */
    ...
    public function setMeasurementInfo(array $measurementInfo = array())
    {
        foreach ($measurementInfo as $cabinOptionTypeMeasurementInfoItem) {
            // validation for constraint: itemType
            if (!$cabinOptionTypeMeasurementInfoItem instanceof \OtaInterface\Otaconnect\StructType\MeasurementInfo) {
                throw new \InvalidArgumentException(sprintf('The MeasurementInfo property can only contain items of \OtaInterface\Otaconnect\StructType\MeasurementInfo, "%s" given', is_object($cabinOptionTypeMeasurementInfoItem) ? get_class($cabinOptionTypeMeasurementInfoItem) : gettype($cabinOptionTypeMeasurementInfoItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\MeasurementInfo $item
     * @return \OtaInterface\Otaconnect\StructType\CabinOptionType
     */
    public function addToMeasurementInfo(\OtaInterface\Otaconnect\StructType\MeasurementInfo $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\MeasurementInfo) {
            throw new \InvalidArgumentException(sprintf('The MeasurementInfo property can only contain items of \OtaInterface\Otaconnect\StructType\MeasurementInfo, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
