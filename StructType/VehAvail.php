...
class VehAvail extends AbstractStructBase
{
     ...
     */
    public function __construct($vehAvailCore = null, $vehAvailInfo = null, \OtaInterface\Otaconnect\StructType\AdvanceBooking $advanceBooking = null)
    {
        $this
     ...
     * @param mixed $vehAvailCore
     * @return \OtaInterface\Otaconnect\StructType\VehAvail
     */
