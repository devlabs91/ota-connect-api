...
class PaymentDetailType extends PaymentFormType
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\PaymentAmount[] $paymentAmount
     * @return \OtaInterface\Otaconnect\StructType\PaymentDetailType
     */
    public function setPaymentAmount(array $paymentAmount = array())
    {
        foreach ($paymentAmount as $paymentDetailTypePaymentAmountItem) {
            ...
            if (!$paymentDetailTypePaymentAmountItem instanceof \OtaInterface\Otaconnect\StructType\PaymentAmount) {
                throw new \InvalidArgumentException(sprintf('The PaymentAmount property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentAmount, "%s" given', is_object($paymentDetailTypePaymentAmountItem) ? get_class($paymentDetailTypePaymentAmountItem) : gettype($paymentDetailTypePaymentAmountItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PaymentAmount $item
     * @return \OtaInterface\Otaconnect\StructType\PaymentDetailType
     */
    public function addToPaymentAmount(\OtaInterface\Otaconnect\StructType\PaymentAmount $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PaymentAmount) {
            throw new \InvalidArgumentException(sprintf('The PaymentAmount property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentAmount, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
