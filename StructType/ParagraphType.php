...
class ParagraphType extends AbstractStructBase
{
    ...
    /**
     * The ListItem
     * @var \OtaInterface\Otaconnect\StructType\ListItem
     */
    public $ListItem;
    /**
     * The Name
     ...
     * @param string $image
     * @param string $uRL
     * @param \OtaInterface\Otaconnect\StructType\ListItem $listItem
     * @param string $name
     * @param int $paragraphNumber
     */
    public function __construct($text = null, $image = null, $uRL = null, \OtaInterface\Otaconnect\StructType\ListItem $listItem = null, $name = null, $paragraphNumber = null)
    {
        $this
            ->setText($text)
            ->setImage($image)
     ...
     * Set Text value
     * @param mixed $text
     * @return \OtaInterface\Otaconnect\StructType\ParagraphType
     */
    ...
    /**
     * Get ListItem value
     * @return \OtaInterface\Otaconnect\StructType\ListItem|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\ParagraphType
     */
    public function setListItem(\OtaInterface\Otaconnect\StructType\ListItem $listItem = null)
    {
