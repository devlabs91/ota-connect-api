...
class LengthOfStay extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\LOS_Pattern
     */
    public $LOS_Pattern;
    /**
     * The Time
     ...
     * @param \OtaInterface\Otaconnect\StructType\LOS_Pattern $lOS_Pattern
     * @param int $time
     * @param string $timeUnit
     * @param bool $openStatusIndicator
     * @param string $minMaxMessageType
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\LOS_Pattern $lOS_Pattern = null, $time = null, $timeUnit = null, $openStatusIndicator = null, $minMaxMessageType = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\LOS_Pattern|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LOS_Pattern $lOS_Pattern
     * @return \OtaInterface\Otaconnect\StructType\LengthOfStay
     */
    public function setLOS_Pattern(\OtaInterface\Otaconnect\StructType\LOS_Pattern $lOS_Pattern = null)
    {
