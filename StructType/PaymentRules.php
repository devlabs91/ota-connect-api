...
class PaymentRules extends PaymentRulesType
{
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AcceptablePayments[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayments[] $acceptablePayments
     ...
     * @return \OtaInterface\Otaconnect\StructType\AcceptablePayments[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayments[] $acceptablePayments
     * @return \OtaInterface\Otaconnect\StructType\PaymentRules
     */
    public function setAcceptablePayments(array $acceptablePayments = array())
    {
        foreach ($acceptablePayments as $paymentRulesAcceptablePaymentsItem) {
            ...
            if (!$paymentRulesAcceptablePaymentsItem instanceof \OtaInterface\Otaconnect\StructType\AcceptablePayments) {
                throw new \InvalidArgumentException(sprintf('The AcceptablePayments property can only contain items of \OtaInterface\Otaconnect\StructType\AcceptablePayments, "%s" given', is_object($paymentRulesAcceptablePaymentsItem) ? get_class($paymentRulesAcceptablePaymentsItem) : gettype($paymentRulesAcceptablePaymentsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayments $item
     * @return \OtaInterface\Otaconnect\StructType\PaymentRules
     */
    public function addToAcceptablePayments(\OtaInterface\Otaconnect\StructType\AcceptablePayments $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AcceptablePayments) {
            throw new \InvalidArgumentException(sprintf('The AcceptablePayments property can only contain items of \OtaInterface\Otaconnect\StructType\AcceptablePayments, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
