...
class Criteria extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: unbounded
     * @var \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType[]
     */
    public $Criterion;
    /**
     * The MinimumAge
     ...
     * @param \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType[] $criterion
    ...
    /**
     * Get Criterion value
     * @return \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType[] $criterion
     * @return \OtaInterface\Otaconnect\StructType\Criteria
     */
    public function setCriterion(array $criterion = array())
    {
        foreach ($criterion as $criteriaCriterionItem) {
            // validation for constraint: itemType
            if (!$criteriaCriterionItem instanceof \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType) {
                throw new \InvalidArgumentException(sprintf('The Criterion property can only contain items of \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType, "%s" given', is_object($criteriaCriterionItem) ? get_class($criteriaCriterionItem) : gettype($criteriaCriterionItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType $item
     * @return \OtaInterface\Otaconnect\StructType\Criteria
     */
    public function addToCriterion(\OtaInterface\Otaconnect\StructType\HotelSearchCriterionType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType) {
            throw new \InvalidArgumentException(sprintf('The Criterion property can only contain items of \OtaInterface\Otaconnect\StructType\HotelSearchCriterionType, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Criterion[] = $item;
        return $this;
    }
