 ...
 * @subpackage Structs
 */
class OtherServiceInformation extends OtherServiceInfoType
{
    /**
     * The RPH
     * Meta informations extracted from the WSDL
     * - documentation: Unique value associated with the OSI.
     * - use: optional
     * @var string
     */
    public $RPH;
     ...
     * @uses OtherServiceInformation::setRPH()
     * @uses OtherServiceInformation::setOperation()
     * @param string $rPH
     * @param string $operation
     */
    public function __construct($rPH = null, $operation = null)
    {
        $this
            ->setRPH($rPH)
     ...
     * Set RPH value
     * @param string $rPH
     * @return \OtaInterface\Otaconnect\StructType\OtherServiceInformation
     */
