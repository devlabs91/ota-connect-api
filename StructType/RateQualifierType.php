...
class RateQualifierType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\RateComments
     */
    public $RateComments;
    /**
     * The ArriveByFlight
     ...
     * @param \OtaInterface\Otaconnect\StructType\RateComments $rateComments
     * @param bool $arriveByFlight
     * @param string $rateAuthorizationCode
     * @param string $vendorRateID
     */
    public function __construct($promoDesc = null, \OtaInterface\Otaconnect\StructType\RateComments $rateComments = null, $arriveByFlight = null, $rateAuthorizationCode = null, $vendorRateID = null)
    {
        $this
     ...
     * Set PromoDesc value
     * @param mixed $promoDesc
     * @return \OtaInterface\Otaconnect\StructType\RateQualifierType
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RateComments|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RateQualifierType
     */
    public function setRateComments(\OtaInterface\Otaconnect\StructType\RateComments $rateComments = null)
    {
