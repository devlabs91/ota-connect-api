...
class VehicleRentalCoreType extends AbstractStructBase
{
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PickUpLocation[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\ReturnLocation
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PickUpLocation[] $pickUpLocation
     * @param \OtaInterface\Otaconnect\StructType\ReturnLocation $returnLocation
     ...
     */
    public function __construct(array $pickUpLocation = array(), \OtaInterface\Otaconnect\StructType\ReturnLocation $returnLocation = null, $pickUpDateTime = null, $returnDateTime = null, $startChargesDateTime = null, $stopChargesDateTime = null, $oneWayIndicator = null, $multiIslandRentalDays = null, $quantity = null, $distUnitName = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\PickUpLocation[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PickUpLocation[] $pickUpLocation
     * @return \OtaInterface\Otaconnect\StructType\VehicleRentalCoreType
     */
    public function setPickUpLocation(array $pickUpLocation = array())
    {
        foreach ($pickUpLocation as $vehicleRentalCoreTypePickUpLocationItem) {
            ...
            if (!$vehicleRentalCoreTypePickUpLocationItem instanceof \OtaInterface\Otaconnect\StructType\PickUpLocation) {
                throw new \InvalidArgumentException(sprintf('The PickUpLocation property can only contain items of \OtaInterface\Otaconnect\StructType\PickUpLocation, "%s" given', is_object($vehicleRentalCoreTypePickUpLocationItem) ? get_class($vehicleRentalCoreTypePickUpLocationItem) : gettype($vehicleRentalCoreTypePickUpLocationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PickUpLocation $item
     * @return \OtaInterface\Otaconnect\StructType\VehicleRentalCoreType
     */
    public function addToPickUpLocation(\OtaInterface\Otaconnect\StructType\PickUpLocation $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PickUpLocation) {
            throw new \InvalidArgumentException(sprintf('The PickUpLocation property can only contain items of \OtaInterface\Otaconnect\StructType\PickUpLocation, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\ReturnLocation|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\VehicleRentalCoreType
     */
    public function setReturnLocation(\OtaInterface\Otaconnect\StructType\ReturnLocation $returnLocation = null)
    {
