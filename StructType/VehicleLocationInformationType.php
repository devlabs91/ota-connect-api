 ...
 * - documentation: The VehicleLocationInformationType complex type provides formatted textual information relating to the vehicle rental location. The type of information is indicated.
 * @subpackage Structs
 */
class VehicleLocationInformationType extends FormattedTextType
{
     ...
     * Set Type value
     * @param string $type
     * @return \OtaInterface\Otaconnect\StructType\VehicleLocationInformationType
     */
