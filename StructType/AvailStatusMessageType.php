...
class AvailStatusMessageType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\BestAvailableRates
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\HurdleRate
     */
    public $HurdleRate;
    /**
     * The Delta
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Delta
     */
    public $Delta;
    /**
     * The UniqueID
     ...
     * @param \OtaInterface\Otaconnect\StructType\BestAvailableRates $bestAvailableRates
     * @param \OtaInterface\Otaconnect\StructType\HurdleRate $hurdleRate
     * @param \OtaInterface\Otaconnect\StructType\Delta $delta
     ...
     */
    public function __construct($statusApplicationControl = null, $lengthsOfStay = null, \OtaInterface\Otaconnect\StructType\BestAvailableRates $bestAvailableRates = null, \OtaInterface\Otaconnect\StructType\HurdleRate $hurdleRate = null, \OtaInterface\Otaconnect\StructType\Delta $delta = null, $uniqueID = null, \OtaInterface\Otaconnect\StructType\RestrictionStatus $restrictionStatus = null, $override = null, $bookingLimitMessageType = null, $bookingLimit = null, $locatorID = null, $bookingThreshold = null)
    {
        $this
     ...
     * @param mixed $statusApplicationControl
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessageType
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\BestAvailableRates|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessageType
     */
    public function setBestAvailableRates(\OtaInterface\Otaconnect\StructType\BestAvailableRates $bestAvailableRates = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\HurdleRate|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessageType
     */
    public function setHurdleRate(\OtaInterface\Otaconnect\StructType\HurdleRate $hurdleRate = null)
    {
    ...
    /**
     * Get Delta value
     * @return \OtaInterface\Otaconnect\StructType\Delta|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessageType
     */
    public function setDelta(\OtaInterface\Otaconnect\StructType\Delta $delta = null)
    {
        $this->Delta = $delta;
        return $this;
    }
