...
class FareInfo extends FareInfoType
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Fare
     */
    public $Fare;
    /**
     * The PTC
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PTC[]
     */
    public $PTC;
    /**
     * The FareBasisCode
     ...
     * @param \OtaInterface\Otaconnect\StructType\Fare $fare
     * @param \OtaInterface\Otaconnect\StructType\PTC[] $pTC
     ...
     */
    public function __construct($tPA_Extensions = null, $operation = null, $rPH = null, array $date = array(), \OtaInterface\Otaconnect\StructType\Fare $fare = null, array $pTC = array(), $fareBasisCode = null, $globalIndicatorCode = null, $maximumPermittedMileage = null, $tripType = null, $fareType = null, $fareStatus = null, $passengerFare = null)
    {
        $this
     ...
     * @param mixed $tPA_Extensions
     * @return \OtaInterface\Otaconnect\StructType\FareInfo
     */
    ...
    public function setDate(array $date = array())
    {
        foreach ($date as $fareInfoDateItem) {
            ...
            if (!$fareInfoDateItem instanceof \OtaInterface\Otaconnect\StructType\Date) {
                throw new \InvalidArgumentException(sprintf('The Date property can only contain items of \OtaInterface\Otaconnect\StructType\Date, "%s" given', is_object($fareInfoDateItem) ? get_class($fareInfoDateItem) : gettype($fareInfoDateItem)), __LINE__);
            }
        }
        $this->Date = $date;
        return $this;
    ...
    /**
     * Get Fare value
     * @return \OtaInterface\Otaconnect\StructType\Fare|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\FareInfo
     */
    public function setFare(\OtaInterface\Otaconnect\StructType\Fare $fare = null)
    {
        $this->Fare = $fare;
        return $this;
    }
    /**
     * Get PTC value
     * @return \OtaInterface\Otaconnect\StructType\PTC[]|null
     */
    ...
    public function setPTC(array $pTC = array())
    {
        foreach ($pTC as $fareInfoPTCItem) {
            // validation for constraint: itemType
            if (!$fareInfoPTCItem instanceof \OtaInterface\Otaconnect\StructType\PTC) {
                throw new \InvalidArgumentException(sprintf('The PTC property can only contain items of \OtaInterface\Otaconnect\StructType\PTC, "%s" given', is_object($fareInfoPTCItem) ? get_class($fareInfoPTCItem) : gettype($fareInfoPTCItem)), __LINE__);
            }
        }
        $this->PTC = $pTC;
        return $this;
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PTC $item
     * @return \OtaInterface\Otaconnect\StructType\FareInfo
     */
    public function addToPTC(\OtaInterface\Otaconnect\StructType\PTC $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PTC) {
            throw new \InvalidArgumentException(sprintf('The PTC property can only contain items of \OtaInterface\Otaconnect\StructType\PTC, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->PTC[] = $item;
        return $this;
    }
