...
class OtherServiceInfoType extends AbstractStructBase
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\TravelerRefNumber[] $travelerRefNumber
     * @return \OtaInterface\Otaconnect\StructType\OtherServiceInfoType
     */
    public function setTravelerRefNumber(array $travelerRefNumber = array())
    {
        foreach ($travelerRefNumber as $otherServiceInfoTypeTravelerRefNumberItem) {
            ...
            if (!$otherServiceInfoTypeTravelerRefNumberItem instanceof \OtaInterface\Otaconnect\StructType\TravelerRefNumber) {
                throw new \InvalidArgumentException(sprintf('The TravelerRefNumber property can only contain items of \OtaInterface\Otaconnect\StructType\TravelerRefNumber, "%s" given', is_object($otherServiceInfoTypeTravelerRefNumberItem) ? get_class($otherServiceInfoTypeTravelerRefNumberItem) : gettype($otherServiceInfoTypeTravelerRefNumberItem)), __LINE__);
            }
        }
