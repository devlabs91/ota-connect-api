...
class HotelAdditionalChargesType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 99
     * @var \OtaInterface\Otaconnect\StructType\AdditionalCharge[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AdditionalCharge[] $additionalCharge
     ...
     * @return \OtaInterface\Otaconnect\StructType\AdditionalCharge[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AdditionalCharge[] $additionalCharge
     * @return \OtaInterface\Otaconnect\StructType\HotelAdditionalChargesType
     */
    public function setAdditionalCharge(array $additionalCharge = array())
    {
        foreach ($additionalCharge as $hotelAdditionalChargesTypeAdditionalChargeItem) {
            ...
            if (!$hotelAdditionalChargesTypeAdditionalChargeItem instanceof \OtaInterface\Otaconnect\StructType\AdditionalCharge) {
                throw new \InvalidArgumentException(sprintf('The AdditionalCharge property can only contain items of \OtaInterface\Otaconnect\StructType\AdditionalCharge, "%s" given', is_object($hotelAdditionalChargesTypeAdditionalChargeItem) ? get_class($hotelAdditionalChargesTypeAdditionalChargeItem) : gettype($hotelAdditionalChargesTypeAdditionalChargeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AdditionalCharge $item
     * @return \OtaInterface\Otaconnect\StructType\HotelAdditionalChargesType
     */
    public function addToAdditionalCharge(\OtaInterface\Otaconnect\StructType\AdditionalCharge $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AdditionalCharge) {
            throw new \InvalidArgumentException(sprintf('The AdditionalCharge property can only contain items of \OtaInterface\Otaconnect\StructType\AdditionalCharge, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
