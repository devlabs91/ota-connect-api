...
class RoomTypeType extends AbstractStructBase
{
     ...
     */
    public function __construct($roomDescription = null, $additionalDetails = null, \OtaInterface\Otaconnect\StructType\Amenities $amenities = null, array $occupancy = array(), $tPA_Extensions = null, $numberOfUnits = null, $isRoom = null, $isConverted = null, $isAlternate = null, $reqdGuaranteeType = null)
    {
        $this
     ...
     * @param mixed $roomDescription
     * @return \OtaInterface\Otaconnect\StructType\RoomTypeType
     */
    ...
    public function setOccupancy(array $occupancy = array())
    {
        foreach ($occupancy as $roomTypeTypeOccupancyItem) {
            ...
            if (!$roomTypeTypeOccupancyItem instanceof \OtaInterface\Otaconnect\StructType\Occupancy) {
                throw new \InvalidArgumentException(sprintf('The Occupancy property can only contain items of \OtaInterface\Otaconnect\StructType\Occupancy, "%s" given', is_object($roomTypeTypeOccupancyItem) ? get_class($roomTypeTypeOccupancyItem) : gettype($roomTypeTypeOccupancyItem)), __LINE__);
            }
        }
