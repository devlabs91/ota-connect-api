...
class RoomRateType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Features
     */
    public $Features;
    /**
     * The Total
     ...
     * @param \OtaInterface\Otaconnect\StructType\Features $features
     * @param mixed $total
     ...
     * @param string $roomID
     */
    public function __construct($rates = null, array $roomRateDescription = array(), \OtaInterface\Otaconnect\StructType\Features $features = null, $total = null, array $availability = array(), $bookingCode = null, $roomTypeCode = null, $invBlockCode = null, $numberOfUnits = null, $availabilityStatus = null, $roomID = null)
    {
        $this
            ->setRates($rates)
     ...
     * Set Rates value
     * @param mixed $rates
     * @return \OtaInterface\Otaconnect\StructType\RoomRateType
     */
    ...
    /**
     * Get Features value
     * @return \OtaInterface\Otaconnect\StructType\Features|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RoomRateType
     */
    public function setFeatures(\OtaInterface\Otaconnect\StructType\Features $features = null)
    {
    ...
    public function setAvailability(array $availability = array())
    {
        foreach ($availability as $roomRateTypeAvailabilityItem) {
            // validation for constraint: itemType
            if (!$roomRateTypeAvailabilityItem instanceof \OtaInterface\Otaconnect\StructType\Availability) {
                throw new \InvalidArgumentException(sprintf('The Availability property can only contain items of \OtaInterface\Otaconnect\StructType\Availability, "%s" given', is_object($roomRateTypeAvailabilityItem) ? get_class($roomRateTypeAvailabilityItem) : gettype($roomRateTypeAvailabilityItem)), __LINE__);
            }
        }
