...
class AvailStatusMessages extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * @var \OtaInterface\Otaconnect\StructType\AvailStatusMessageType[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AvailStatusMessageType[] $availStatusMessage
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessageType[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AvailStatusMessageType[] $availStatusMessage
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessages
     */
    public function setAvailStatusMessage(array $availStatusMessage = array())
    {
        foreach ($availStatusMessage as $availStatusMessagesAvailStatusMessageItem) {
            ...
            if (!$availStatusMessagesAvailStatusMessageItem instanceof \OtaInterface\Otaconnect\StructType\AvailStatusMessageType) {
                throw new \InvalidArgumentException(sprintf('The AvailStatusMessage property can only contain items of \OtaInterface\Otaconnect\StructType\AvailStatusMessageType, "%s" given', is_object($availStatusMessagesAvailStatusMessageItem) ? get_class($availStatusMessagesAvailStatusMessageItem) : gettype($availStatusMessagesAvailStatusMessageItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AvailStatusMessageType $item
     * @return \OtaInterface\Otaconnect\StructType\AvailStatusMessages
     */
    public function addToAvailStatusMessage(\OtaInterface\Otaconnect\StructType\AvailStatusMessageType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AvailStatusMessageType) {
            throw new \InvalidArgumentException(sprintf('The AvailStatusMessage property can only contain items of \OtaInterface\Otaconnect\StructType\AvailStatusMessageType, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
