...
class TextDescriptionType extends AbstractStructBase
{
     ...
     * Set URL value
     * @param string $uRL
     * @return \OtaInterface\Otaconnect\StructType\TextDescriptionType
     */
    ...
    public function setDescription(array $description = array())
    {
        foreach ($description as $textDescriptionTypeDescriptionItem) {
            ...
            if (!$textDescriptionTypeDescriptionItem instanceof \OtaInterface\Otaconnect\StructType\Description) {
                throw new \InvalidArgumentException(sprintf('The Description property can only contain items of \OtaInterface\Otaconnect\StructType\Description, "%s" given', is_object($textDescriptionTypeDescriptionItem) ? get_class($textDescriptionTypeDescriptionItem) : gettype($textDescriptionTypeDescriptionItem)), __LINE__);
            }
        }
