...
class VendorPrefs extends AbstractStructBase
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\VendorPref[] $vendorPref
     * @return \OtaInterface\Otaconnect\StructType\VendorPrefs
     */
    public function setVendorPref(array $vendorPref = array())
    {
        foreach ($vendorPref as $vendorPrefsVendorPrefItem) {
            // validation for constraint: itemType
            if (!$vendorPrefsVendorPrefItem instanceof \OtaInterface\Otaconnect\StructType\VendorPref) {
                throw new \InvalidArgumentException(sprintf('The VendorPref property can only contain items of \OtaInterface\Otaconnect\StructType\VendorPref, "%s" given', is_object($vendorPrefsVendorPrefItem) ? get_class($vendorPrefsVendorPrefItem) : gettype($vendorPrefsVendorPrefItem)), __LINE__);
            }
        }
