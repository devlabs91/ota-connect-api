...
class Endorsements extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 9
     * @var \OtaInterface\Otaconnect\StructType\Endorsement[]
     */
    public $Endorsement;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\Endorsement[] $endorsement
     ...
     * @return \OtaInterface\Otaconnect\StructType\Endorsement[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Endorsement[] $endorsement
     * @return \OtaInterface\Otaconnect\StructType\Endorsements
     */
    public function setEndorsement(array $endorsement = array())
    {
        foreach ($endorsement as $endorsementsEndorsementItem) {
            // validation for constraint: itemType
            if (!$endorsementsEndorsementItem instanceof \OtaInterface\Otaconnect\StructType\Endorsement) {
                throw new \InvalidArgumentException(sprintf('The Endorsement property can only contain items of \OtaInterface\Otaconnect\StructType\Endorsement, "%s" given', is_object($endorsementsEndorsementItem) ? get_class($endorsementsEndorsementItem) : gettype($endorsementsEndorsementItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Endorsement $item
     * @return \OtaInterface\Otaconnect\StructType\Endorsements
     */
    public function addToEndorsement(\OtaInterface\Otaconnect\StructType\Endorsement $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Endorsement) {
            throw new \InvalidArgumentException(sprintf('The Endorsement property can only contain items of \OtaInterface\Otaconnect\StructType\Endorsement, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
