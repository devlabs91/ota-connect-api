...
class AccountInformation extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\TaxRegistrationDetails
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\TaxRegistrationDetails $taxRegistrationDetails
     * @param string $number
     * @param string $costCenter
     * @param string $companyNumber
     * @param string $clientReference
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\TaxRegistrationDetails $taxRegistrationDetails = null, $number = null, $costCenter = null, $companyNumber = null, $clientReference = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\TaxRegistrationDetails|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\TaxRegistrationDetails $taxRegistrationDetails
     * @return \OtaInterface\Otaconnect\StructType\AccountInformation
     */
    public function setTaxRegistrationDetails(\OtaInterface\Otaconnect\StructType\TaxRegistrationDetails $taxRegistrationDetails = null)
    {
