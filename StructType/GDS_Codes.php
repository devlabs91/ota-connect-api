...
class GDS_Codes extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\GDS_Code[]
     */
    public $GDS_Code;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\GDS_Code[] $gDS_Code
    ...
    /**
     * Get GDS_Code value
     * @return \OtaInterface\Otaconnect\StructType\GDS_Code[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\GDS_Code[] $gDS_Code
     * @return \OtaInterface\Otaconnect\StructType\GDS_Codes
     */
    public function setGDS_Code(array $gDS_Code = array())
    {
        foreach ($gDS_Code as $gDS_CodesGDS_CodeItem) {
            // validation for constraint: itemType
            if (!$gDS_CodesGDS_CodeItem instanceof \OtaInterface\Otaconnect\StructType\GDS_Code) {
                throw new \InvalidArgumentException(sprintf('The GDS_Code property can only contain items of \OtaInterface\Otaconnect\StructType\GDS_Code, "%s" given', is_object($gDS_CodesGDS_CodeItem) ? get_class($gDS_CodesGDS_CodeItem) : gettype($gDS_CodesGDS_CodeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\GDS_Code $item
     * @return \OtaInterface\Otaconnect\StructType\GDS_Codes
     */
    public function addToGDS_Code(\OtaInterface\Otaconnect\StructType\GDS_Code $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\GDS_Code) {
            throw new \InvalidArgumentException(sprintf('The GDS_Code property can only contain items of \OtaInterface\Otaconnect\StructType\GDS_Code, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->GDS_Code[] = $item;
        return $this;
    }
