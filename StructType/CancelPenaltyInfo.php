...
class CancelPenaltyInfo extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PenaltyFee
     */
    public $PenaltyFee;
    /**
     * The Description
     ...
     * @param \OtaInterface\Otaconnect\StructType\PenaltyFee $penaltyFee
     * @param mixed $description
     * @param bool $guaranteeRequiredInd
     * @param bool $modifyPenaltyInd
     */
    public function __construct(array $deadline = array(), \OtaInterface\Otaconnect\StructType\PenaltyFee $penaltyFee = null, $description = null, $guaranteeRequiredInd = null, $modifyPenaltyInd = null)
    {
        $this
     ...
     * @param \OtaInterface\Otaconnect\StructType\Deadline[] $deadline
     * @return \OtaInterface\Otaconnect\StructType\CancelPenaltyInfo
     */
    public function setDeadline(array $deadline = array())
    {
        foreach ($deadline as $cancelPenaltyInfoDeadlineItem) {
            // validation for constraint: itemType
            if (!$cancelPenaltyInfoDeadlineItem instanceof \OtaInterface\Otaconnect\StructType\Deadline) {
                throw new \InvalidArgumentException(sprintf('The Deadline property can only contain items of \OtaInterface\Otaconnect\StructType\Deadline, "%s" given', is_object($cancelPenaltyInfoDeadlineItem) ? get_class($cancelPenaltyInfoDeadlineItem) : gettype($cancelPenaltyInfoDeadlineItem)), __LINE__);
            }
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\PenaltyFee|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\CancelPenaltyInfo
     */
    public function setPenaltyFee(\OtaInterface\Otaconnect\StructType\PenaltyFee $penaltyFee = null)
    {
