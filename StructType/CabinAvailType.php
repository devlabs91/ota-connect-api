...
class CabinAvailType extends AbstractStructBase
{
     ...
     * @param string $meal
     */
    public function __construct(array $seat = array(), \OtaInterface\Otaconnect\StructType\BaggageAllowance $baggageAllowance = null, $meal = null)
    {
        $this
            ->setSeat($seat)
     ...
     * @param mixed[] $seat
     * @return \OtaInterface\Otaconnect\StructType\CabinAvailType
     */
