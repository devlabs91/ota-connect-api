...
class PkgPassengerListItem extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\SpecialNeed[]
     */
    public $SpecialNeed;
    /**
     ...
     * @param mixed $name
     * @param \OtaInterface\Otaconnect\StructType\SpecialNeed[] $specialNeed
     ...
     * Set Name value
     * @param mixed $name
     * @return \OtaInterface\Otaconnect\StructType\PkgPassengerListItem
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\SpecialNeed[]|null
     */
    ...
    public function setSpecialNeed(array $specialNeed = array())
    {
        foreach ($specialNeed as $pkgPassengerListItemSpecialNeedItem) {
            ...
            if (!$pkgPassengerListItemSpecialNeedItem instanceof \OtaInterface\Otaconnect\StructType\SpecialNeed) {
                throw new \InvalidArgumentException(sprintf('The SpecialNeed property can only contain items of \OtaInterface\Otaconnect\StructType\SpecialNeed, "%s" given', is_object($pkgPassengerListItemSpecialNeedItem) ? get_class($pkgPassengerListItemSpecialNeedItem) : gettype($pkgPassengerListItemSpecialNeedItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\SpecialNeed $item
     * @return \OtaInterface\Otaconnect\StructType\PkgPassengerListItem
     */
    public function addToSpecialNeed(\OtaInterface\Otaconnect\StructType\SpecialNeed $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\SpecialNeed) {
            throw new \InvalidArgumentException(sprintf('The SpecialNeed property can only contain items of \OtaInterface\Otaconnect\StructType\SpecialNeed, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
