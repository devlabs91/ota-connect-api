...
class CommissionPolicy extends FeeType
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PaymentCompany[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PaymentCompany[] $paymentCompany
     ...
     * @return \OtaInterface\Otaconnect\StructType\PaymentCompany[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PaymentCompany[] $paymentCompany
     * @return \OtaInterface\Otaconnect\StructType\CommissionPolicy
     */
    public function setPaymentCompany(array $paymentCompany = array())
    {
        foreach ($paymentCompany as $commissionPolicyPaymentCompanyItem) {
            ...
            if (!$commissionPolicyPaymentCompanyItem instanceof \OtaInterface\Otaconnect\StructType\PaymentCompany) {
                throw new \InvalidArgumentException(sprintf('The PaymentCompany property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentCompany, "%s" given', is_object($commissionPolicyPaymentCompanyItem) ? get_class($commissionPolicyPaymentCompanyItem) : gettype($commissionPolicyPaymentCompanyItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PaymentCompany $item
     * @return \OtaInterface\Otaconnect\StructType\CommissionPolicy
     */
    public function addToPaymentCompany(\OtaInterface\Otaconnect\StructType\PaymentCompany $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PaymentCompany) {
            throw new \InvalidArgumentException(sprintf('The PaymentCompany property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentCompany, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
