...
class SpecialRemarkType extends AbstractStructBase
{
     ...
     * - maxOccurs: 10
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\FlightRefNumber[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AuthorizedViewers
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\FlightRefNumber[] $flightRefNumber
     * @param string $text
     * @param mixed[] $airline
     * @param \OtaInterface\Otaconnect\StructType\AuthorizedViewers $authorizedViewers
     * @param string $iD
     */
    public function __construct($remarkType = null, array $travelerRefNumber = array(), array $flightRefNumber = array(), $text = null, array $airline = array(), \OtaInterface\Otaconnect\StructType\AuthorizedViewers $authorizedViewers = null, $iD = null)
    {
        $this
     ...
     * @param string $remarkType
     * @return \OtaInterface\Otaconnect\StructType\SpecialRemarkType
     */
    ...
    public function setTravelerRefNumber(array $travelerRefNumber = array())
    {
        foreach ($travelerRefNumber as $specialRemarkTypeTravelerRefNumberItem) {
            ...
            if (!$specialRemarkTypeTravelerRefNumberItem instanceof \OtaInterface\Otaconnect\StructType\TravelerRefNumber) {
                throw new \InvalidArgumentException(sprintf('The TravelerRefNumber property can only contain items of \OtaInterface\Otaconnect\StructType\TravelerRefNumber, "%s" given', is_object($specialRemarkTypeTravelerRefNumberItem) ? get_class($specialRemarkTypeTravelerRefNumberItem) : gettype($specialRemarkTypeTravelerRefNumberItem)), __LINE__);
            }
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\FlightRefNumber[]|null
     */
    ...
    public function setFlightRefNumber(array $flightRefNumber = array())
    {
        foreach ($flightRefNumber as $specialRemarkTypeFlightRefNumberItem) {
            // validation for constraint: itemType
            if (!$specialRemarkTypeFlightRefNumberItem instanceof \OtaInterface\Otaconnect\StructType\FlightRefNumber) {
                throw new \InvalidArgumentException(sprintf('The FlightRefNumber property can only contain items of \OtaInterface\Otaconnect\StructType\FlightRefNumber, "%s" given', is_object($specialRemarkTypeFlightRefNumberItem) ? get_class($specialRemarkTypeFlightRefNumberItem) : gettype($specialRemarkTypeFlightRefNumberItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\FlightRefNumber $item
     * @return \OtaInterface\Otaconnect\StructType\SpecialRemarkType
     */
    public function addToFlightRefNumber(\OtaInterface\Otaconnect\StructType\FlightRefNumber $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\FlightRefNumber) {
            throw new \InvalidArgumentException(sprintf('The FlightRefNumber property can only contain items of \OtaInterface\Otaconnect\StructType\FlightRefNumber, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\AuthorizedViewers|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\SpecialRemarkType
     */
    public function setAuthorizedViewers(\OtaInterface\Otaconnect\StructType\AuthorizedViewers $authorizedViewers = null)
    {
