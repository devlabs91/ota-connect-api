...
class X509DataType extends AbstractStructBase
{
     ...
     * @var \OtaInterface\Otaconnect\StructType\X509IssuerSerialType
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\X509IssuerSerialType $x509IssuerSerial
     ...
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\X509IssuerSerialType $x509IssuerSerial = null, $x509SKI = null, $x509SubjectName = null, $x509Certificate = null, $x509CRL = null, \DOMDocument $any = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\X509IssuerSerialType|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\X509IssuerSerialType $x509IssuerSerial
     * @return \OtaInterface\Otaconnect\StructType\X509DataType
     */
    public function setX509IssuerSerial(\OtaInterface\Otaconnect\StructType\X509IssuerSerialType $x509IssuerSerial = null)
    {
     ...
     * @uses \DOMNode::item()
     * @uses \OtaInterface\Otaconnect\StructType\X509DataType::setAny()
