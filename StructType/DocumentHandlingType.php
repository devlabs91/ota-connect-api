...
class DocumentHandlingType extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\VendorOption[]
     */
    public $VendorOption;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\VendorOption[] $vendorOption
     ...
     * @return \OtaInterface\Otaconnect\StructType\VendorOption[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\VendorOption[] $vendorOption
     * @return \OtaInterface\Otaconnect\StructType\DocumentHandlingType
     */
    public function setVendorOption(array $vendorOption = array())
    {
        foreach ($vendorOption as $documentHandlingTypeVendorOptionItem) {
            ...
            if (!$documentHandlingTypeVendorOptionItem instanceof \OtaInterface\Otaconnect\StructType\VendorOption) {
                throw new \InvalidArgumentException(sprintf('The VendorOption property can only contain items of \OtaInterface\Otaconnect\StructType\VendorOption, "%s" given', is_object($documentHandlingTypeVendorOptionItem) ? get_class($documentHandlingTypeVendorOptionItem) : gettype($documentHandlingTypeVendorOptionItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\VendorOption $item
     * @return \OtaInterface\Otaconnect\StructType\DocumentHandlingType
     */
    public function addToVendorOption(\OtaInterface\Otaconnect\StructType\VendorOption $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\VendorOption) {
            throw new \InvalidArgumentException(sprintf('The VendorOption property can only contain items of \OtaInterface\Otaconnect\StructType\VendorOption, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
