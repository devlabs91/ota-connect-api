...
class AirReservationType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Queues
     */
    public $Queues;
    /**
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PricingOverview
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Queues $queues
     * @param \OtaInterface\Otaconnect\StructType\BookingReferenceID[] $bookingReferenceID
     * @param mixed $comment
     * @param \OtaInterface\Otaconnect\StructType\PricingOverview $pricingOverview
     * @param string $lastModified
     */
    public function __construct($airItinerary = null, $priceInfo = null, $travelerInfo = null, $fulfillment = null, array $ticketing = array(), \OtaInterface\Otaconnect\StructType\Queues $queues = null, array $bookingReferenceID = array(), $comment = null, \OtaInterface\Otaconnect\StructType\PricingOverview $pricingOverview = null, $lastModified = null)
    {
        $this
     ...
     * @param mixed $airItinerary
     * @return \OtaInterface\Otaconnect\StructType\AirReservationType
     */
    ...
    /**
     * Get Queues value
     * @return \OtaInterface\Otaconnect\StructType\Queues|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AirReservationType
     */
    public function setQueues(\OtaInterface\Otaconnect\StructType\Queues $queues = null)
    {
        $this->Queues = $queues;
        return $this;
    }
    ...
    public function setBookingReferenceID(array $bookingReferenceID = array())
    {
        foreach ($bookingReferenceID as $airReservationTypeBookingReferenceIDItem) {
            // validation for constraint: itemType
            if (!$airReservationTypeBookingReferenceIDItem instanceof \OtaInterface\Otaconnect\StructType\BookingReferenceID) {
                throw new \InvalidArgumentException(sprintf('The BookingReferenceID property can only contain items of \OtaInterface\Otaconnect\StructType\BookingReferenceID, "%s" given', is_object($airReservationTypeBookingReferenceIDItem) ? get_class($airReservationTypeBookingReferenceIDItem) : gettype($airReservationTypeBookingReferenceIDItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\BookingReferenceID $item
     * @return \OtaInterface\Otaconnect\StructType\AirReservationType
     */
    public function addToBookingReferenceID(\OtaInterface\Otaconnect\StructType\BookingReferenceID $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\BookingReferenceID) {
            throw new \InvalidArgumentException(sprintf('The BookingReferenceID property can only contain items of \OtaInterface\Otaconnect\StructType\BookingReferenceID, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\PricingOverview|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AirReservationType
     */
    public function setPricingOverview(\OtaInterface\Otaconnect\StructType\PricingOverview $pricingOverview = null)
    {
