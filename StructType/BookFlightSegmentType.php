...
class BookFlightSegmentType extends FlightSegmentType
{
     ...
     * - maxOccurs: 3
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\BookingClassAvails[]
     */
     ...
     * - maxOccurs: 9
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\StopLocation[]
     */
    public $StopLocation;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\BookingClassAvails[] $bookingClassAvails
     * @param mixed[] $comment
     * @param \OtaInterface\Otaconnect\StructType\StopLocation[] $stopLocation
     ...
     * @param mixed $marriageGrp
     * @return \OtaInterface\Otaconnect\StructType\BookFlightSegmentType
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\BookingClassAvails[]|null
     */
    ...
    public function setBookingClassAvails(array $bookingClassAvails = array())
    {
        foreach ($bookingClassAvails as $bookFlightSegmentTypeBookingClassAvailsItem) {
            ...
            if (!$bookFlightSegmentTypeBookingClassAvailsItem instanceof \OtaInterface\Otaconnect\StructType\BookingClassAvails) {
                throw new \InvalidArgumentException(sprintf('The BookingClassAvails property can only contain items of \OtaInterface\Otaconnect\StructType\BookingClassAvails, "%s" given', is_object($bookFlightSegmentTypeBookingClassAvailsItem) ? get_class($bookFlightSegmentTypeBookingClassAvailsItem) : gettype($bookFlightSegmentTypeBookingClassAvailsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\BookingClassAvails $item
     * @return \OtaInterface\Otaconnect\StructType\BookFlightSegmentType
     */
    public function addToBookingClassAvails(\OtaInterface\Otaconnect\StructType\BookingClassAvails $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\BookingClassAvails) {
            throw new \InvalidArgumentException(sprintf('The BookingClassAvails property can only contain items of \OtaInterface\Otaconnect\StructType\BookingClassAvails, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\StopLocation[]|null
     */
    ...
    public function setStopLocation(array $stopLocation = array())
    {
        foreach ($stopLocation as $bookFlightSegmentTypeStopLocationItem) {
            // validation for constraint: itemType
            if (!$bookFlightSegmentTypeStopLocationItem instanceof \OtaInterface\Otaconnect\StructType\StopLocation) {
                throw new \InvalidArgumentException(sprintf('The StopLocation property can only contain items of \OtaInterface\Otaconnect\StructType\StopLocation, "%s" given', is_object($bookFlightSegmentTypeStopLocationItem) ? get_class($bookFlightSegmentTypeStopLocationItem) : gettype($bookFlightSegmentTypeStopLocationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\StopLocation $item
     * @return \OtaInterface\Otaconnect\StructType\BookFlightSegmentType
     */
    public function addToStopLocation(\OtaInterface\Otaconnect\StructType\StopLocation $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\StopLocation) {
            throw new \InvalidArgumentException(sprintf('The StopLocation property can only contain items of \OtaInterface\Otaconnect\StructType\StopLocation, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
