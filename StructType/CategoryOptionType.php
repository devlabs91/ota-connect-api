...
class CategoryOptionType extends AbstractStructBase
{
     ...
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\PriceInfos $priceInfos = null, array $dining = array(), $status = null, $heldIndicator = null, $categoryLocation = null, $maxOccupancy = null, $listOfCategoryQualifierCodes = null, $availableGroupAllocationQty = null)
    {
        $this
     ...
     * @param \OtaInterface\Otaconnect\StructType\PriceInfos $priceInfos
     * @return \OtaInterface\Otaconnect\StructType\CategoryOptionType
     */
    ...
    public function setDining(array $dining = array())
    {
        foreach ($dining as $categoryOptionTypeDiningItem) {
            ...
            if (!$categoryOptionTypeDiningItem instanceof \OtaInterface\Otaconnect\StructType\Dining) {
                throw new \InvalidArgumentException(sprintf('The Dining property can only contain items of \OtaInterface\Otaconnect\StructType\Dining, "%s" given', is_object($categoryOptionTypeDiningItem) ? get_class($categoryOptionTypeDiningItem) : gettype($categoryOptionTypeDiningItem)), __LINE__);
            }
        }
        $this->Dining = $dining;
        return $this;
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Dining $item
     * @return \OtaInterface\Otaconnect\StructType\CategoryOptionType
     */
    public function addToDining(\OtaInterface\Otaconnect\StructType\Dining $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Dining) {
            throw new \InvalidArgumentException(sprintf('The Dining property can only contain items of \OtaInterface\Otaconnect\StructType\Dining, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Dining[] = $item;
        return $this;
    }
