...
class TravelerInfoType extends AbstractStructBase
{
     ...
     * - maxOccurs: 99
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AirTraveler[]
     */
    public $AirTraveler;
    /**
     ...
     * @param \OtaInterface\Otaconnect\StructType\AirTraveler[] $airTraveler
     ...
     * @return \OtaInterface\Otaconnect\StructType\AirTraveler[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AirTraveler[] $airTraveler
     * @return \OtaInterface\Otaconnect\StructType\TravelerInfoType
     */
    public function setAirTraveler(array $airTraveler = array())
    {
        foreach ($airTraveler as $travelerInfoTypeAirTravelerItem) {
            // validation for constraint: itemType
            if (!$travelerInfoTypeAirTravelerItem instanceof \OtaInterface\Otaconnect\StructType\AirTraveler) {
                throw new \InvalidArgumentException(sprintf('The AirTraveler property can only contain items of \OtaInterface\Otaconnect\StructType\AirTraveler, "%s" given', is_object($travelerInfoTypeAirTravelerItem) ? get_class($travelerInfoTypeAirTravelerItem) : gettype($travelerInfoTypeAirTravelerItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AirTraveler $item
     * @return \OtaInterface\Otaconnect\StructType\TravelerInfoType
     */
    public function addToAirTraveler(\OtaInterface\Otaconnect\StructType\AirTraveler $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AirTraveler) {
            throw new \InvalidArgumentException(sprintf('The AirTraveler property can only contain items of \OtaInterface\Otaconnect\StructType\AirTraveler, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
