...
class CruisePackageType extends AbstractStructBase
{
     ...
     * - maxOccurs: 16
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Location[]
     */
    public $Location;
    /**
     * The Status
     ...
     * @param \OtaInterface\Otaconnect\StructType\Location[] $location
     * @param string $status
     */
     ...
     * @param string $packageTypeCode
     * @return \OtaInterface\Otaconnect\StructType\CruisePackageType
     */
    ...
    /**
     * Get Location value
     * @return \OtaInterface\Otaconnect\StructType\Location[]|null
     */
    ...
    public function setLocation(array $location = array())
    {
        foreach ($location as $cruisePackageTypeLocationItem) {
            ...
            if (!$cruisePackageTypeLocationItem instanceof \OtaInterface\Otaconnect\StructType\Location) {
                throw new \InvalidArgumentException(sprintf('The Location property can only contain items of \OtaInterface\Otaconnect\StructType\Location, "%s" given', is_object($cruisePackageTypeLocationItem) ? get_class($cruisePackageTypeLocationItem) : gettype($cruisePackageTypeLocationItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Location $item
     * @return \OtaInterface\Otaconnect\StructType\CruisePackageType
     */
    public function addToLocation(\OtaInterface\Otaconnect\StructType\Location $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Location) {
            throw new \InvalidArgumentException(sprintf('The Location property can only contain items of \OtaInterface\Otaconnect\StructType\Location, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Location[] = $item;
        return $this;
    }
