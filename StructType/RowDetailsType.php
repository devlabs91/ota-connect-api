...
class RowDetailsType extends AbstractStructBase
{
    ...
    /**
     * The AirSeats
     * @var \OtaInterface\Otaconnect\StructType\AirSeats
     */
    public $AirSeats;
    /**
     * The AirRowCharacteristics
     * @var \OtaInterface\Otaconnect\StructType\AirRowCharacteristics
     */
     ...
     * @param int $rowNumber
     * @param \OtaInterface\Otaconnect\StructType\AirSeats $airSeats
     * @param \OtaInterface\Otaconnect\StructType\AirRowCharacteristics $airRowCharacteristics
     * @param string $maxNumberOfSeats
     * @param string $airBookDesigCode
     */
    public function __construct($rowNumber = null, \OtaInterface\Otaconnect\StructType\AirSeats $airSeats = null, \OtaInterface\Otaconnect\StructType\AirRowCharacteristics $airRowCharacteristics = null, $maxNumberOfSeats = null, $airBookDesigCode = null)
    {
        $this
     ...
     * Set RowNumber value
     * @param int $rowNumber
     * @return \OtaInterface\Otaconnect\StructType\RowDetailsType
     */
    ...
    /**
     * Get AirSeats value
     * @return \OtaInterface\Otaconnect\StructType\AirSeats|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RowDetailsType
     */
    public function setAirSeats(\OtaInterface\Otaconnect\StructType\AirSeats $airSeats = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\AirRowCharacteristics|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RowDetailsType
     */
    public function setAirRowCharacteristics(\OtaInterface\Otaconnect\StructType\AirRowCharacteristics $airRowCharacteristics = null)
    {
