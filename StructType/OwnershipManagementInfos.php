...
class OwnershipManagementInfos extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 99
     * @var \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo[] $ownershipManagementInfo
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo[] $ownershipManagementInfo
     * @return \OtaInterface\Otaconnect\StructType\OwnershipManagementInfos
     */
    public function setOwnershipManagementInfo(array $ownershipManagementInfo = array())
    {
        foreach ($ownershipManagementInfo as $ownershipManagementInfosOwnershipManagementInfoItem) {
            ...
            if (!$ownershipManagementInfosOwnershipManagementInfoItem instanceof \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo) {
                throw new \InvalidArgumentException(sprintf('The OwnershipManagementInfo property can only contain items of \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo, "%s" given', is_object($ownershipManagementInfosOwnershipManagementInfoItem) ? get_class($ownershipManagementInfosOwnershipManagementInfoItem) : gettype($ownershipManagementInfosOwnershipManagementInfoItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo $item
     * @return \OtaInterface\Otaconnect\StructType\OwnershipManagementInfos
     */
    public function addToOwnershipManagementInfo(\OtaInterface\Otaconnect\StructType\OwnershipManagementInfo $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo) {
            throw new \InvalidArgumentException(sprintf('The OwnershipManagementInfo property can only contain items of \OtaInterface\Otaconnect\StructType\OwnershipManagementInfo, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
