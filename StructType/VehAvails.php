...
class VehAvails extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 99
     * @var \OtaInterface\Otaconnect\StructType\VehAvail[]
     */
    public $VehAvail;
    /**
     * The RateCategory
     ...
     * @param \OtaInterface\Otaconnect\StructType\VehAvail[] $vehAvail
    ...
    /**
     * Get VehAvail value
     * @return \OtaInterface\Otaconnect\StructType\VehAvail[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\VehAvail[] $vehAvail
     * @return \OtaInterface\Otaconnect\StructType\VehAvails
     */
    public function setVehAvail(array $vehAvail = array())
    {
        foreach ($vehAvail as $vehAvailsVehAvailItem) {
            // validation for constraint: itemType
            if (!$vehAvailsVehAvailItem instanceof \OtaInterface\Otaconnect\StructType\VehAvail) {
                throw new \InvalidArgumentException(sprintf('The VehAvail property can only contain items of \OtaInterface\Otaconnect\StructType\VehAvail, "%s" given', is_object($vehAvailsVehAvailItem) ? get_class($vehAvailsVehAvailItem) : gettype($vehAvailsVehAvailItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\VehAvail $item
     * @return \OtaInterface\Otaconnect\StructType\VehAvails
     */
    public function addToVehAvail(\OtaInterface\Otaconnect\StructType\VehAvail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\VehAvail) {
            throw new \InvalidArgumentException(sprintf('The VehAvail property can only contain items of \OtaInterface\Otaconnect\StructType\VehAvail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->VehAvail[] = $item;
        return $this;
    }
