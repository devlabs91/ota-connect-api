...
class RateAmountMessageType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Rates
     */
    public $Rates;
    /**
     * The LocatorID
     ...
     * @param \OtaInterface\Otaconnect\StructType\Rates $rates
     * @param int $locatorID
     */
    public function __construct($statusApplicationControl = null, \OtaInterface\Otaconnect\StructType\Rates $rates = null, $locatorID = null)
    {
        $this
     ...
     * @param mixed $statusApplicationControl
     * @return \OtaInterface\Otaconnect\StructType\RateAmountMessageType
     */
    ...
    /**
     * Get Rates value
     * @return \OtaInterface\Otaconnect\StructType\Rates|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RateAmountMessageType
     */
    public function setRates(\OtaInterface\Otaconnect\StructType\Rates $rates = null)
    {
        $this->Rates = $rates;
        return $this;
    }
