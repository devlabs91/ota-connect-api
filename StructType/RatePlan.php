...
class RatePlan extends RateUploadType
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\MarketCode[]
     */
    public $MarketCode;
    /**
     * The Commission
     ...
     * @param \OtaInterface\Otaconnect\StructType\MarketCode[] $marketCode
     ...
     */
    public function __construct(array $marketCode = array(), $commission = null, array $methodInfo = array(), \OtaInterface\Otaconnect\StructType\DaysOfWeeks $daysOfWeeks = null, $ratePlanCode = null, $bookingCode = null, $upgradeIndicator = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\MarketCode[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\MarketCode[] $marketCode
     * @return \OtaInterface\Otaconnect\StructType\RatePlan
     */
    public function setMarketCode(array $marketCode = array())
    {
        foreach ($marketCode as $ratePlanMarketCodeItem) {
            // validation for constraint: itemType
            if (!$ratePlanMarketCodeItem instanceof \OtaInterface\Otaconnect\StructType\MarketCode) {
                throw new \InvalidArgumentException(sprintf('The MarketCode property can only contain items of \OtaInterface\Otaconnect\StructType\MarketCode, "%s" given', is_object($ratePlanMarketCodeItem) ? get_class($ratePlanMarketCodeItem) : gettype($ratePlanMarketCodeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\MarketCode $item
     * @return \OtaInterface\Otaconnect\StructType\RatePlan
     */
    public function addToMarketCode(\OtaInterface\Otaconnect\StructType\MarketCode $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\MarketCode) {
            throw new \InvalidArgumentException(sprintf('The MarketCode property can only contain items of \OtaInterface\Otaconnect\StructType\MarketCode, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    public function setMethodInfo(array $methodInfo = array())
    {
        foreach ($methodInfo as $ratePlanMethodInfoItem) {
            // validation for constraint: itemType
            if (!$ratePlanMethodInfoItem instanceof \OtaInterface\Otaconnect\StructType\MethodInfo) {
                throw new \InvalidArgumentException(sprintf('The MethodInfo property can only contain items of \OtaInterface\Otaconnect\StructType\MethodInfo, "%s" given', is_object($ratePlanMethodInfoItem) ? get_class($ratePlanMethodInfoItem) : gettype($ratePlanMethodInfoItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\MethodInfo $item
     * @return \OtaInterface\Otaconnect\StructType\RatePlan
     */
    public function addToMethodInfo(\OtaInterface\Otaconnect\StructType\MethodInfo $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\MethodInfo) {
            throw new \InvalidArgumentException(sprintf('The MethodInfo property can only contain items of \OtaInterface\Otaconnect\StructType\MethodInfo, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
