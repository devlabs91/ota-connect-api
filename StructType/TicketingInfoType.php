...
class TicketingInfoType extends AbstractStructBase
{
     ...
     * - maxOccurs: 10
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\TicketAdvisory[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\TicketingVendor
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PricingSystem
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\TicketAdvisory[] $ticketAdvisory
     * @param \OtaInterface\Otaconnect\StructType\TicketingVendor $ticketingVendor
     * @param \OtaInterface\Otaconnect\StructType\PricingSystem $pricingSystem
     ...
     */
    public function __construct(array $ticketAdvisory = array(), \OtaInterface\Otaconnect\StructType\TicketingVendor $ticketingVendor = null, \OtaInterface\Otaconnect\StructType\PricingSystem $pricingSystem = null, \OtaInterface\Otaconnect\StructType\TotalFare $totalFare = null, $ticketTimeLimit = null, $cancelOnExpiryInd = null, $ticketType = null, $ticketingStatus = null, $flightSegmentRefNumber = null, $travelerRefNumber = null, $reverseTktgSegmentsInd = null, $pseudoCityCode = null, $requestedTicketingDate = null, $timeLimitMinutes = null, $bookingChangeType = null, $ticketDocumentNbr = null, $passengerTypeCode = null, $operation = null, $miscTicketingCode = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\TicketAdvisory[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\TicketAdvisory[] $ticketAdvisory
     * @return \OtaInterface\Otaconnect\StructType\TicketingInfoType
     */
    public function setTicketAdvisory(array $ticketAdvisory = array())
    {
        foreach ($ticketAdvisory as $ticketingInfoTypeTicketAdvisoryItem) {
            ...
            if (!$ticketingInfoTypeTicketAdvisoryItem instanceof \OtaInterface\Otaconnect\StructType\TicketAdvisory) {
                throw new \InvalidArgumentException(sprintf('The TicketAdvisory property can only contain items of \OtaInterface\Otaconnect\StructType\TicketAdvisory, "%s" given', is_object($ticketingInfoTypeTicketAdvisoryItem) ? get_class($ticketingInfoTypeTicketAdvisoryItem) : gettype($ticketingInfoTypeTicketAdvisoryItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\TicketAdvisory $item
     * @return \OtaInterface\Otaconnect\StructType\TicketingInfoType
     */
    public function addToTicketAdvisory(\OtaInterface\Otaconnect\StructType\TicketAdvisory $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\TicketAdvisory) {
            throw new \InvalidArgumentException(sprintf('The TicketAdvisory property can only contain items of \OtaInterface\Otaconnect\StructType\TicketAdvisory, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\TicketingVendor|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\TicketingInfoType
     */
    public function setTicketingVendor(\OtaInterface\Otaconnect\StructType\TicketingVendor $ticketingVendor = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\PricingSystem|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\TicketingInfoType
     */
    public function setPricingSystem(\OtaInterface\Otaconnect\StructType\PricingSystem $pricingSystem = null)
    {
