...
class ContactInfoType extends AbstractStructBase
{
     ...
     */
    public function __construct($names = null, $addresses = null, $phones = null, $emails = null, $uRLs = null, \OtaInterface\Otaconnect\StructType\CompanyName $companyName = null, $location = null)
    {
        $this
            ->setNames($names)
     ...
     * Set Names value
     * @param mixed $names
     * @return \OtaInterface\Otaconnect\StructType\ContactInfoType
     */
