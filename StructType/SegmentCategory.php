 ...
 * - documentation: Defines the type of hotel such as luxury, extended stay, economy. | May be used to give further detail on the code or to remove an obsolete item.
 * @subpackage Structs
 */
class SegmentCategory extends AbstractStructBase
{
     ...
     * Set Code value
     * @param string $code
     * @return \OtaInterface\Otaconnect\StructType\SegmentCategory
     */
