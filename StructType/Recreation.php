...
class Recreation extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\RecreationDetails
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\RecreationDetails $recreationDetails
     ...
     * @param int $sort
     */
    public function __construct($code = null, $contact = null, $operationSchedules = null, $refPoints = null, \OtaInterface\Otaconnect\StructType\MultimediaDescriptions $multimediaDescriptions = null, \OtaInterface\Otaconnect\StructType\RecreationDetails $recreationDetails = null, $descriptiveText = null, $name = null, $proximityCode = null, $included = null, $existsCode = null, $sort = null)
    {
        $this
            ->setCode($code)
            ->setContact($contact)
     ...
     * Set Code value
     * @param string $code
     * @return \OtaInterface\Otaconnect\StructType\Recreation
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\RecreationDetails|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\Recreation
     */
    public function setRecreationDetails(\OtaInterface\Otaconnect\StructType\RecreationDetails $recreationDetails = null)
    {
