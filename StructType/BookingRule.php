...
class BookingRule extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AcceptableGuarantees
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AddtionalRules
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptableGuarantees $acceptableGuarantees
     ...
     * @param \OtaInterface\Otaconnect\StructType\AddtionalRules $addtionalRules
     ...
     * @return \OtaInterface\Otaconnect\StructType\AcceptableGuarantees|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptableGuarantees $acceptableGuarantees
     * @return \OtaInterface\Otaconnect\StructType\BookingRule
     */
    public function setAcceptableGuarantees(\OtaInterface\Otaconnect\StructType\AcceptableGuarantees $acceptableGuarantees = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\AddtionalRules|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\BookingRule
     */
    public function setAddtionalRules(\OtaInterface\Otaconnect\StructType\AddtionalRules $addtionalRules = null)
    {
    ...
    public function setCheckoutCharge(array $checkoutCharge = array())
    {
        foreach ($checkoutCharge as $bookingRuleCheckoutChargeItem) {
            // validation for constraint: itemType
            if (!$bookingRuleCheckoutChargeItem instanceof \OtaInterface\Otaconnect\StructType\CheckoutCharge) {
                throw new \InvalidArgumentException(sprintf('The CheckoutCharge property can only contain items of \OtaInterface\Otaconnect\StructType\CheckoutCharge, "%s" given', is_object($bookingRuleCheckoutChargeItem) ? get_class($bookingRuleCheckoutChargeItem) : gettype($bookingRuleCheckoutChargeItem)), __LINE__);
            }
        }
