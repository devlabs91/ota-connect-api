...
class VehicleProfileRentalPrefType extends AbstractStructBase
{
     ...
     * - maxOccurs: 20
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\LoyaltyPref[]
     */
    public $LoyaltyPref;
    /**
     * The VendorPref
     ...
     * - maxOccurs: 10
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PaymentFormPref[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyPref[] $loyaltyPref
     * @param mixed[] $vendorPref
     * @param \OtaInterface\Otaconnect\StructType\PaymentFormPref[] $paymentFormPref
     ...
     * @return \OtaInterface\Otaconnect\StructType\LoyaltyPref[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyPref[] $loyaltyPref
     * @return \OtaInterface\Otaconnect\StructType\VehicleProfileRentalPrefType
     */
    public function setLoyaltyPref(array $loyaltyPref = array())
    {
        foreach ($loyaltyPref as $vehicleProfileRentalPrefTypeLoyaltyPrefItem) {
            ...
            if (!$vehicleProfileRentalPrefTypeLoyaltyPrefItem instanceof \OtaInterface\Otaconnect\StructType\LoyaltyPref) {
                throw new \InvalidArgumentException(sprintf('The LoyaltyPref property can only contain items of \OtaInterface\Otaconnect\StructType\LoyaltyPref, "%s" given', is_object($vehicleProfileRentalPrefTypeLoyaltyPrefItem) ? get_class($vehicleProfileRentalPrefTypeLoyaltyPrefItem) : gettype($vehicleProfileRentalPrefTypeLoyaltyPrefItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyPref $item
     * @return \OtaInterface\Otaconnect\StructType\VehicleProfileRentalPrefType
     */
    public function addToLoyaltyPref(\OtaInterface\Otaconnect\StructType\LoyaltyPref $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\LoyaltyPref) {
            throw new \InvalidArgumentException(sprintf('The LoyaltyPref property can only contain items of \OtaInterface\Otaconnect\StructType\LoyaltyPref, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\PaymentFormPref[]|null
     */
    ...
    public function setPaymentFormPref(array $paymentFormPref = array())
    {
        foreach ($paymentFormPref as $vehicleProfileRentalPrefTypePaymentFormPrefItem) {
            // validation for constraint: itemType
            if (!$vehicleProfileRentalPrefTypePaymentFormPrefItem instanceof \OtaInterface\Otaconnect\StructType\PaymentFormPref) {
                throw new \InvalidArgumentException(sprintf('The PaymentFormPref property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentFormPref, "%s" given', is_object($vehicleProfileRentalPrefTypePaymentFormPrefItem) ? get_class($vehicleProfileRentalPrefTypePaymentFormPrefItem) : gettype($vehicleProfileRentalPrefTypePaymentFormPrefItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PaymentFormPref $item
     * @return \OtaInterface\Otaconnect\StructType\VehicleProfileRentalPrefType
     */
    public function addToPaymentFormPref(\OtaInterface\Otaconnect\StructType\PaymentFormPref $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PaymentFormPref) {
            throw new \InvalidArgumentException(sprintf('The PaymentFormPref property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentFormPref, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    public function setCoveragePref(array $coveragePref = array())
    {
        foreach ($coveragePref as $vehicleProfileRentalPrefTypeCoveragePrefItem) {
            // validation for constraint: itemType
            if (!$vehicleProfileRentalPrefTypeCoveragePrefItem instanceof \OtaInterface\Otaconnect\StructType\CoveragePref) {
                throw new \InvalidArgumentException(sprintf('The CoveragePref property can only contain items of \OtaInterface\Otaconnect\StructType\CoveragePref, "%s" given', is_object($vehicleProfileRentalPrefTypeCoveragePrefItem) ? get_class($vehicleProfileRentalPrefTypeCoveragePrefItem) : gettype($vehicleProfileRentalPrefTypeCoveragePrefItem)), __LINE__);
            }
        }
    ...
    public function setSpecialEquipPref(array $specialEquipPref = array())
    {
        foreach ($specialEquipPref as $vehicleProfileRentalPrefTypeSpecialEquipPrefItem) {
            // validation for constraint: itemType
            if (!$vehicleProfileRentalPrefTypeSpecialEquipPrefItem instanceof \OtaInterface\Otaconnect\StructType\SpecialEquipPref) {
                throw new \InvalidArgumentException(sprintf('The SpecialEquipPref property can only contain items of \OtaInterface\Otaconnect\StructType\SpecialEquipPref, "%s" given', is_object($vehicleProfileRentalPrefTypeSpecialEquipPrefItem) ? get_class($vehicleProfileRentalPrefTypeSpecialEquipPrefItem) : gettype($vehicleProfileRentalPrefTypeSpecialEquipPrefItem)), __LINE__);
            }
        }
