...
class RoomStay extends RoomStayType
{
     ...
     * @param mixed $resGuestRPHs
     * @return \OtaInterface\Otaconnect\StructType\RoomStay
     */
     ...
     * @uses \OtaInterface\Otaconnect\EnumType\RateIndicatorType::valueIsValid()
     * @uses \OtaInterface\Otaconnect\EnumType\RateIndicatorType::getValidValues()
    ...
    public function setAvailabilityStatus($availabilityStatus = null)
    {
        ...
        if (!\OtaInterface\Otaconnect\EnumType\RateIndicatorType::valueIsValid($availabilityStatus)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $availabilityStatus, implode(', ', \OtaInterface\Otaconnect\EnumType\RateIndicatorType::getValidValues())), __LINE__);
        }
