...
class MeetingRoom extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Codes
     */
    public $Codes;
    /**
     * The Dimension
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Dimension
     */
    public $Dimension;
    /**
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AvailableCapacities
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Codes $codes
     * @param \OtaInterface\Otaconnect\StructType\Dimension $dimension
     * @param \OtaInterface\Otaconnect\StructType\AvailableCapacities $availableCapacities
     ...
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\Codes $codes = null, \OtaInterface\Otaconnect\StructType\Dimension $dimension = null, \OtaInterface\Otaconnect\StructType\AvailableCapacities $availableCapacities = null, $features = null, $multimediaDescriptions = null, $irregular = null, $propertySystemName = null, $roomName = null, $sort = null, $meetingRoomCapacity = null, $access = null, $meetingRoomTypeCode = null, $meetingRoomLevel = null, $dedicatedIndicator = null)
    {
        $this
            ->setCodes($codes)
    ...
    /**
     * Get Codes value
     * @return \OtaInterface\Otaconnect\StructType\Codes|null
     */
     ...
     * Set Codes value
     * @param \OtaInterface\Otaconnect\StructType\Codes $codes
     * @return \OtaInterface\Otaconnect\StructType\MeetingRoom
     */
    public function setCodes(\OtaInterface\Otaconnect\StructType\Codes $codes = null)
    {
        $this->Codes = $codes;
        return $this;
    }
    /**
     * Get Dimension value
     * @return \OtaInterface\Otaconnect\StructType\Dimension|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\MeetingRoom
     */
    public function setDimension(\OtaInterface\Otaconnect\StructType\Dimension $dimension = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailableCapacities|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\MeetingRoom
     */
    public function setAvailableCapacities(\OtaInterface\Otaconnect\StructType\AvailableCapacities $availableCapacities = null)
    {
