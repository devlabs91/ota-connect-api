...
class SailingType extends SailingInfoType
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\Dining[] $dining
     * @return \OtaInterface\Otaconnect\StructType\SailingType
     */
    public function setDining(array $dining = array())
    {
        foreach ($dining as $sailingTypeDiningItem) {
            // validation for constraint: itemType
            if (!$sailingTypeDiningItem instanceof \OtaInterface\Otaconnect\StructType\Dining) {
                throw new \InvalidArgumentException(sprintf('The Dining property can only contain items of \OtaInterface\Otaconnect\StructType\Dining, "%s" given', is_object($sailingTypeDiningItem) ? get_class($sailingTypeDiningItem) : gettype($sailingTypeDiningItem)), __LINE__);
            }
        }
        $this->Dining = $dining;
        return $this;
