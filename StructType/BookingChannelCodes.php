...
class BookingChannelCodes extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: unbounded
     * @var \OtaInterface\Otaconnect\StructType\BookingChannelCode[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\BookingChannelCode[] $bookingChannelCode
     ...
     * @return \OtaInterface\Otaconnect\StructType\BookingChannelCode[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\BookingChannelCode[] $bookingChannelCode
     * @return \OtaInterface\Otaconnect\StructType\BookingChannelCodes
     */
    public function setBookingChannelCode(array $bookingChannelCode = array())
    {
        foreach ($bookingChannelCode as $bookingChannelCodesBookingChannelCodeItem) {
            ...
            if (!$bookingChannelCodesBookingChannelCodeItem instanceof \OtaInterface\Otaconnect\StructType\BookingChannelCode) {
                throw new \InvalidArgumentException(sprintf('The BookingChannelCode property can only contain items of \OtaInterface\Otaconnect\StructType\BookingChannelCode, "%s" given', is_object($bookingChannelCodesBookingChannelCodeItem) ? get_class($bookingChannelCodesBookingChannelCodeItem) : gettype($bookingChannelCodesBookingChannelCodeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\BookingChannelCode $item
     * @return \OtaInterface\Otaconnect\StructType\BookingChannelCodes
     */
    public function addToBookingChannelCode(\OtaInterface\Otaconnect\StructType\BookingChannelCode $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\BookingChannelCode) {
            throw new \InvalidArgumentException(sprintf('The BookingChannelCode property can only contain items of \OtaInterface\Otaconnect\StructType\BookingChannelCode, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
