...
class LoyaltyRedemption extends AbstractStructBase
{
     ...
     * - maxOccurs: 9
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\LoyaltyCertificate[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyCertificate[] $loyaltyCertificate
     ...
     * @return \OtaInterface\Otaconnect\StructType\LoyaltyCertificate[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyCertificate[] $loyaltyCertificate
     * @return \OtaInterface\Otaconnect\StructType\LoyaltyRedemption
     */
    public function setLoyaltyCertificate(array $loyaltyCertificate = array())
    {
        foreach ($loyaltyCertificate as $loyaltyRedemptionLoyaltyCertificateItem) {
            ...
            if (!$loyaltyRedemptionLoyaltyCertificateItem instanceof \OtaInterface\Otaconnect\StructType\LoyaltyCertificate) {
                throw new \InvalidArgumentException(sprintf('The LoyaltyCertificate property can only contain items of \OtaInterface\Otaconnect\StructType\LoyaltyCertificate, "%s" given', is_object($loyaltyRedemptionLoyaltyCertificateItem) ? get_class($loyaltyRedemptionLoyaltyCertificateItem) : gettype($loyaltyRedemptionLoyaltyCertificateItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\LoyaltyCertificate $item
     * @return \OtaInterface\Otaconnect\StructType\LoyaltyRedemption
     */
    public function addToLoyaltyCertificate(\OtaInterface\Otaconnect\StructType\LoyaltyCertificate $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\LoyaltyCertificate) {
            throw new \InvalidArgumentException(sprintf('The LoyaltyCertificate property can only contain items of \OtaInterface\Otaconnect\StructType\LoyaltyCertificate, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
