...
class BookingClassAvails extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 26
     * @var \OtaInterface\Otaconnect\StructType\BookingClassAvail[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\BookingClassAvail[] $bookingClassAvail
     ...
     * @return \OtaInterface\Otaconnect\StructType\BookingClassAvail[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\BookingClassAvail[] $bookingClassAvail
     * @return \OtaInterface\Otaconnect\StructType\BookingClassAvails
     */
    public function setBookingClassAvail(array $bookingClassAvail = array())
    {
        foreach ($bookingClassAvail as $bookingClassAvailsBookingClassAvailItem) {
            ...
            if (!$bookingClassAvailsBookingClassAvailItem instanceof \OtaInterface\Otaconnect\StructType\BookingClassAvail) {
                throw new \InvalidArgumentException(sprintf('The BookingClassAvail property can only contain items of \OtaInterface\Otaconnect\StructType\BookingClassAvail, "%s" given', is_object($bookingClassAvailsBookingClassAvailItem) ? get_class($bookingClassAvailsBookingClassAvailItem) : gettype($bookingClassAvailsBookingClassAvailItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\BookingClassAvail $item
     * @return \OtaInterface\Otaconnect\StructType\BookingClassAvails
     */
    public function addToBookingClassAvail(\OtaInterface\Otaconnect\StructType\BookingClassAvail $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\BookingClassAvail) {
            throw new \InvalidArgumentException(sprintf('The BookingClassAvail property can only contain items of \OtaInterface\Otaconnect\StructType\BookingClassAvail, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
