...
class PricingOverview extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PricingIndicator[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PricingIndicator[] $pricingIndicator
     ...
     * @return \OtaInterface\Otaconnect\StructType\PricingIndicator[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\PricingIndicator[] $pricingIndicator
     * @return \OtaInterface\Otaconnect\StructType\PricingOverview
     */
    public function setPricingIndicator(array $pricingIndicator = array())
    {
        foreach ($pricingIndicator as $pricingOverviewPricingIndicatorItem) {
            ...
            if (!$pricingOverviewPricingIndicatorItem instanceof \OtaInterface\Otaconnect\StructType\PricingIndicator) {
                throw new \InvalidArgumentException(sprintf('The PricingIndicator property can only contain items of \OtaInterface\Otaconnect\StructType\PricingIndicator, "%s" given', is_object($pricingOverviewPricingIndicatorItem) ? get_class($pricingOverviewPricingIndicatorItem) : gettype($pricingOverviewPricingIndicatorItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PricingIndicator $item
     * @return \OtaInterface\Otaconnect\StructType\PricingOverview
     */
    public function addToPricingIndicator(\OtaInterface\Otaconnect\StructType\PricingIndicator $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PricingIndicator) {
            throw new \InvalidArgumentException(sprintf('The PricingIndicator property can only contain items of \OtaInterface\Otaconnect\StructType\PricingIndicator, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    public function setAccount(array $account = array())
    {
        foreach ($account as $pricingOverviewAccountItem) {
            // validation for constraint: itemType
            if (!$pricingOverviewAccountItem instanceof \OtaInterface\Otaconnect\StructType\Account) {
                throw new \InvalidArgumentException(sprintf('The Account property can only contain items of \OtaInterface\Otaconnect\StructType\Account, "%s" given', is_object($pricingOverviewAccountItem) ? get_class($pricingOverviewAccountItem) : gettype($pricingOverviewAccountItem)), __LINE__);
            }
        }
