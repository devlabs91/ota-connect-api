...
class AgreementsType extends AbstractStructBase
{
     ...
     * - maxOccurs: 99
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\ProfileSecurity[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\ProfileSecurity[] $profileSecurity
     ...
     * @param mixed[] $certification
     * @return \OtaInterface\Otaconnect\StructType\AgreementsType
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\ProfileSecurity[]|null
     */
    ...
    public function setProfileSecurity(array $profileSecurity = array())
    {
        foreach ($profileSecurity as $agreementsTypeProfileSecurityItem) {
            // validation for constraint: itemType
            if (!$agreementsTypeProfileSecurityItem instanceof \OtaInterface\Otaconnect\StructType\ProfileSecurity) {
                throw new \InvalidArgumentException(sprintf('The ProfileSecurity property can only contain items of \OtaInterface\Otaconnect\StructType\ProfileSecurity, "%s" given', is_object($agreementsTypeProfileSecurityItem) ? get_class($agreementsTypeProfileSecurityItem) : gettype($agreementsTypeProfileSecurityItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\ProfileSecurity $item
     * @return \OtaInterface\Otaconnect\StructType\AgreementsType
     */
    public function addToProfileSecurity(\OtaInterface\Otaconnect\StructType\ProfileSecurity $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\ProfileSecurity) {
            throw new \InvalidArgumentException(sprintf('The ProfileSecurity property can only contain items of \OtaInterface\Otaconnect\StructType\ProfileSecurity, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
