...
class AcceptablePayments extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 20
     * @var \OtaInterface\Otaconnect\StructType\AcceptablePayment[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayment[] $acceptablePayment
     ...
     * @return \OtaInterface\Otaconnect\StructType\AcceptablePayment[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayment[] $acceptablePayment
     * @return \OtaInterface\Otaconnect\StructType\AcceptablePayments
     */
    public function setAcceptablePayment(array $acceptablePayment = array())
    {
        foreach ($acceptablePayment as $acceptablePaymentsAcceptablePaymentItem) {
            ...
            if (!$acceptablePaymentsAcceptablePaymentItem instanceof \OtaInterface\Otaconnect\StructType\AcceptablePayment) {
                throw new \InvalidArgumentException(sprintf('The AcceptablePayment property can only contain items of \OtaInterface\Otaconnect\StructType\AcceptablePayment, "%s" given', is_object($acceptablePaymentsAcceptablePaymentItem) ? get_class($acceptablePaymentsAcceptablePaymentItem) : gettype($acceptablePaymentsAcceptablePaymentItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AcceptablePayment $item
     * @return \OtaInterface\Otaconnect\StructType\AcceptablePayments
     */
    public function addToAcceptablePayment(\OtaInterface\Otaconnect\StructType\AcceptablePayment $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AcceptablePayment) {
            throw new \InvalidArgumentException(sprintf('The AcceptablePayment property can only contain items of \OtaInterface\Otaconnect\StructType\AcceptablePayment, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
