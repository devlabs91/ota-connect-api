...
class GuaranteePayment extends HotelPaymentFormType
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AmountPercent
     */
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Deadline[]
     */
    public $Deadline;
    /**
     * The Description
     ...
     * @param \OtaInterface\Otaconnect\StructType\AmountPercent $amountPercent
     * @param \OtaInterface\Otaconnect\StructType\Deadline[] $deadline
     ...
     * @param string $detailType
     * @return \OtaInterface\Otaconnect\StructType\GuaranteePayment
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AmountPercent|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\GuaranteePayment
     */
    public function setAmountPercent(\OtaInterface\Otaconnect\StructType\AmountPercent $amountPercent = null)
    {
    ...
    /**
     * Get Deadline value
     * @return \OtaInterface\Otaconnect\StructType\Deadline[]|null
     */
    ...
    public function setDeadline(array $deadline = array())
    {
        foreach ($deadline as $guaranteePaymentDeadlineItem) {
            ...
            if (!$guaranteePaymentDeadlineItem instanceof \OtaInterface\Otaconnect\StructType\Deadline) {
                throw new \InvalidArgumentException(sprintf('The Deadline property can only contain items of \OtaInterface\Otaconnect\StructType\Deadline, "%s" given', is_object($guaranteePaymentDeadlineItem) ? get_class($guaranteePaymentDeadlineItem) : gettype($guaranteePaymentDeadlineItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Deadline $item
     * @return \OtaInterface\Otaconnect\StructType\GuaranteePayment
     */
    public function addToDeadline(\OtaInterface\Otaconnect\StructType\Deadline $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Deadline) {
            throw new \InvalidArgumentException(sprintf('The Deadline property can only contain items of \OtaInterface\Otaconnect\StructType\Deadline, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Deadline[] = $item;
        return $this;
    }
    ...
    public function setAddress(array $address = array())
    {
        foreach ($address as $guaranteePaymentAddressItem) {
            // validation for constraint: itemType
            if (!$guaranteePaymentAddressItem instanceof \OtaInterface\Otaconnect\StructType\Address) {
                throw new \InvalidArgumentException(sprintf('The Address property can only contain items of \OtaInterface\Otaconnect\StructType\Address, "%s" given', is_object($guaranteePaymentAddressItem) ? get_class($guaranteePaymentAddressItem) : gettype($guaranteePaymentAddressItem)), __LINE__);
            }
        }
