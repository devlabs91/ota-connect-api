...
class CustomerType extends AbstractStructBase
{
     ...
     * - maxOccurs: 3
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\CitizenCountryName[]
     */
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\PhysChallName[]
     */
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\AdditionalLanguage[]
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\CitizenCountryName[] $citizenCountryName
     * @param \OtaInterface\Otaconnect\StructType\PhysChallName[] $physChallName
     * @param mixed[] $petInfo
     ...
     * @param \OtaInterface\Otaconnect\StructType\AdditionalLanguage[] $additionalLanguage
     ...
     * @param mixed[] $personName
     * @return \OtaInterface\Otaconnect\StructType\CustomerType
     */
    ...
    public function setTelephone(array $telephone = array())
    {
        foreach ($telephone as $customerTypeTelephoneItem) {
            // validation for constraint: itemType
            if (!$customerTypeTelephoneItem instanceof \OtaInterface\Otaconnect\StructType\Telephone) {
                throw new \InvalidArgumentException(sprintf('The Telephone property can only contain items of \OtaInterface\Otaconnect\StructType\Telephone, "%s" given', is_object($customerTypeTelephoneItem) ? get_class($customerTypeTelephoneItem) : gettype($customerTypeTelephoneItem)), __LINE__);
            }
        }
    ...
    public function setEmail(array $email = array())
    {
        foreach ($email as $customerTypeEmailItem) {
            // validation for constraint: itemType
            if (!$customerTypeEmailItem instanceof \OtaInterface\Otaconnect\StructType\Email) {
                throw new \InvalidArgumentException(sprintf('The Email property can only contain items of \OtaInterface\Otaconnect\StructType\Email, "%s" given', is_object($customerTypeEmailItem) ? get_class($customerTypeEmailItem) : gettype($customerTypeEmailItem)), __LINE__);
            }
        }
        $this->Email = $email;
        return $this;
    ...
    public function setAddress(array $address = array())
    {
        foreach ($address as $customerTypeAddressItem) {
            // validation for constraint: itemType
            if (!$customerTypeAddressItem instanceof \OtaInterface\Otaconnect\StructType\Address) {
                throw new \InvalidArgumentException(sprintf('The Address property can only contain items of \OtaInterface\Otaconnect\StructType\Address, "%s" given', is_object($customerTypeAddressItem) ? get_class($customerTypeAddressItem) : gettype($customerTypeAddressItem)), __LINE__);
            }
        }
    ...
    public function setURL(array $uRL = array())
    {
        foreach ($uRL as $customerTypeURLItem) {
            // validation for constraint: itemType
            if (!$customerTypeURLItem instanceof \OtaInterface\Otaconnect\StructType\URL) {
                throw new \InvalidArgumentException(sprintf('The URL property can only contain items of \OtaInterface\Otaconnect\StructType\URL, "%s" given', is_object($customerTypeURLItem) ? get_class($customerTypeURLItem) : gettype($customerTypeURLItem)), __LINE__);
            }
        }
        $this->URL = $uRL;
        return $this;
     ...
     * @return \OtaInterface\Otaconnect\StructType\CitizenCountryName[]|null
     */
    ...
    public function setCitizenCountryName(array $citizenCountryName = array())
    {
        foreach ($citizenCountryName as $customerTypeCitizenCountryNameItem) {
            // validation for constraint: itemType
            if (!$customerTypeCitizenCountryNameItem instanceof \OtaInterface\Otaconnect\StructType\CitizenCountryName) {
                throw new \InvalidArgumentException(sprintf('The CitizenCountryName property can only contain items of \OtaInterface\Otaconnect\StructType\CitizenCountryName, "%s" given', is_object($customerTypeCitizenCountryNameItem) ? get_class($customerTypeCitizenCountryNameItem) : gettype($customerTypeCitizenCountryNameItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\CitizenCountryName $item
     * @return \OtaInterface\Otaconnect\StructType\CustomerType
     */
    public function addToCitizenCountryName(\OtaInterface\Otaconnect\StructType\CitizenCountryName $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\CitizenCountryName) {
            throw new \InvalidArgumentException(sprintf('The CitizenCountryName property can only contain items of \OtaInterface\Otaconnect\StructType\CitizenCountryName, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\PhysChallName[]|null
     */
    ...
    public function setPhysChallName(array $physChallName = array())
    {
        foreach ($physChallName as $customerTypePhysChallNameItem) {
            // validation for constraint: itemType
            if (!$customerTypePhysChallNameItem instanceof \OtaInterface\Otaconnect\StructType\PhysChallName) {
                throw new \InvalidArgumentException(sprintf('The PhysChallName property can only contain items of \OtaInterface\Otaconnect\StructType\PhysChallName, "%s" given', is_object($customerTypePhysChallNameItem) ? get_class($customerTypePhysChallNameItem) : gettype($customerTypePhysChallNameItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\PhysChallName $item
     * @return \OtaInterface\Otaconnect\StructType\CustomerType
     */
    public function addToPhysChallName(\OtaInterface\Otaconnect\StructType\PhysChallName $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\PhysChallName) {
            throw new \InvalidArgumentException(sprintf('The PhysChallName property can only contain items of \OtaInterface\Otaconnect\StructType\PhysChallName, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
    ...
    public function setPaymentForm(array $paymentForm = array())
    {
        foreach ($paymentForm as $customerTypePaymentFormItem) {
            // validation for constraint: itemType
            if (!$customerTypePaymentFormItem instanceof \OtaInterface\Otaconnect\StructType\PaymentForm) {
                throw new \InvalidArgumentException(sprintf('The PaymentForm property can only contain items of \OtaInterface\Otaconnect\StructType\PaymentForm, "%s" given', is_object($customerTypePaymentFormItem) ? get_class($customerTypePaymentFormItem) : gettype($customerTypePaymentFormItem)), __LINE__);
            }
        }
    ...
    public function setCustLoyalty(array $custLoyalty = array())
    {
        foreach ($custLoyalty as $customerTypeCustLoyaltyItem) {
            // validation for constraint: itemType
            if (!$customerTypeCustLoyaltyItem instanceof \OtaInterface\Otaconnect\StructType\CustLoyalty) {
                throw new \InvalidArgumentException(sprintf('The CustLoyalty property can only contain items of \OtaInterface\Otaconnect\StructType\CustLoyalty, "%s" given', is_object($customerTypeCustLoyaltyItem) ? get_class($customerTypeCustLoyaltyItem) : gettype($customerTypeCustLoyaltyItem)), __LINE__);
            }
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\AdditionalLanguage[]|null
     */
    ...
    public function setAdditionalLanguage(array $additionalLanguage = array())
    {
        foreach ($additionalLanguage as $customerTypeAdditionalLanguageItem) {
            // validation for constraint: itemType
            if (!$customerTypeAdditionalLanguageItem instanceof \OtaInterface\Otaconnect\StructType\AdditionalLanguage) {
                throw new \InvalidArgumentException(sprintf('The AdditionalLanguage property can only contain items of \OtaInterface\Otaconnect\StructType\AdditionalLanguage, "%s" given', is_object($customerTypeAdditionalLanguageItem) ? get_class($customerTypeAdditionalLanguageItem) : gettype($customerTypeAdditionalLanguageItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\AdditionalLanguage $item
     * @return \OtaInterface\Otaconnect\StructType\CustomerType
     */
    public function addToAdditionalLanguage(\OtaInterface\Otaconnect\StructType\AdditionalLanguage $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\AdditionalLanguage) {
            throw new \InvalidArgumentException(sprintf('The AdditionalLanguage property can only contain items of \OtaInterface\Otaconnect\StructType\AdditionalLanguage, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
