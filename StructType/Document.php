 ...
 * - documentation: Official travel document information associated with the person traveling.
 * @subpackage Structs
 */
class Document extends DocumentType
{
     ...
     * Set Operation value
     * @param string $operation
     * @return \OtaInterface\Otaconnect\StructType\Document
     */
