 ...
 * - documentation: Used to provide a reference to an object that is stored elsewhere in a collection of the same objects.
 * @subpackage Structs
 */
class ReferencePlaceHolderType extends AbstractStructBase
{
     ...
     * Set RPH value
     * @param string $rPH
     * @return \OtaInterface\Otaconnect\StructType\ReferencePlaceHolderType
     */
