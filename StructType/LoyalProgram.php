...
class LoyalProgram extends AbstractStructBase
{
     ...
     * - maxOccurs: 5
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\ProgramDescription[]
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\ProgramRestriction
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\ProgramDescription[] $programDescription
     * @param \OtaInterface\Otaconnect\StructType\ProgramRestriction $programRestriction
     ...
     */
    public function __construct(array $programDescription = array(), \OtaInterface\Otaconnect\StructType\ProgramRestriction $programRestriction = null, $blackoutDates = null, $programName = null, $secondaryProgramName = null, $affiliateProgramName = null, $hotelLevel = null, $programCode = null, $travelSector = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\ProgramDescription[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\ProgramDescription[] $programDescription
     * @return \OtaInterface\Otaconnect\StructType\LoyalProgram
     */
    public function setProgramDescription(array $programDescription = array())
    {
        foreach ($programDescription as $loyalProgramProgramDescriptionItem) {
            ...
            if (!$loyalProgramProgramDescriptionItem instanceof \OtaInterface\Otaconnect\StructType\ProgramDescription) {
                throw new \InvalidArgumentException(sprintf('The ProgramDescription property can only contain items of \OtaInterface\Otaconnect\StructType\ProgramDescription, "%s" given', is_object($loyalProgramProgramDescriptionItem) ? get_class($loyalProgramProgramDescriptionItem) : gettype($loyalProgramProgramDescriptionItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\ProgramDescription $item
     * @return \OtaInterface\Otaconnect\StructType\LoyalProgram
     */
    public function addToProgramDescription(\OtaInterface\Otaconnect\StructType\ProgramDescription $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\ProgramDescription) {
            throw new \InvalidArgumentException(sprintf('The ProgramDescription property can only contain items of \OtaInterface\Otaconnect\StructType\ProgramDescription, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\ProgramRestriction|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\LoyalProgram
     */
    public function setProgramRestriction(\OtaInterface\Otaconnect\StructType\ProgramRestriction $programRestriction = null)
    {
