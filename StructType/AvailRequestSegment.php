...
class AvailRequestSegment extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\DateTimeSpanType
     */
     ...
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\RatePlanCandidatesType
     */
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\HotelSearchCriteria
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\DateTimeSpanType $stayDateRange
     * @param \OtaInterface\Otaconnect\StructType\RateRange[] $rateRange
     * @param \OtaInterface\Otaconnect\StructType\RatePlanCandidatesType $ratePlanCandidates
     ...
     * @param \OtaInterface\Otaconnect\StructType\HotelSearchCriteria $hotelSearchCriteria
     ...
     */
    public function __construct(\OtaInterface\Otaconnect\StructType\DateTimeSpanType $stayDateRange = null, array $rateRange = array(), \OtaInterface\Otaconnect\StructType\RatePlanCandidatesType $ratePlanCandidates = null, \OtaInterface\Otaconnect\StructType\ProfilesType $profiles = null, \OtaInterface\Otaconnect\StructType\RoomStayCandidates $roomStayCandidates = null, \OtaInterface\Otaconnect\StructType\HotelSearchCriteria $hotelSearchCriteria = null, $tPA_Extensions = null, $availReqType = null, $moreDataEchoToken = null, $infoSource = null, $responseType = null)
    {
        $this
     ...
     * @return \OtaInterface\Otaconnect\StructType\DateTimeSpanType|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\DateTimeSpanType $stayDateRange
     * @return \OtaInterface\Otaconnect\StructType\AvailRequestSegment
     */
    public function setStayDateRange(\OtaInterface\Otaconnect\StructType\DateTimeSpanType $stayDateRange = null)
    {
    ...
    public function setRateRange(array $rateRange = array())
    {
        foreach ($rateRange as $availRequestSegmentRateRangeItem) {
            ...
            if (!$availRequestSegmentRateRangeItem instanceof \OtaInterface\Otaconnect\StructType\RateRange) {
                throw new \InvalidArgumentException(sprintf('The RateRange property can only contain items of \OtaInterface\Otaconnect\StructType\RateRange, "%s" given', is_object($availRequestSegmentRateRangeItem) ? get_class($availRequestSegmentRateRangeItem) : gettype($availRequestSegmentRateRangeItem)), __LINE__);
            }
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\RatePlanCandidatesType|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailRequestSegment
     */
    public function setRatePlanCandidates(\OtaInterface\Otaconnect\StructType\RatePlanCandidatesType $ratePlanCandidates = null)
    {
     ...
     * @return \OtaInterface\Otaconnect\StructType\HotelSearchCriteria|null
     */
     ...
     * @return \OtaInterface\Otaconnect\StructType\AvailRequestSegment
     */
    public function setHotelSearchCriteria(\OtaInterface\Otaconnect\StructType\HotelSearchCriteria $hotelSearchCriteria = null)
    {
