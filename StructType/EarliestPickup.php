 ...
 * - documentation: The earliest day and time a vehicle can be picked up to qualify for a specific rate.
 * @subpackage Structs
 */
class EarliestPickup extends AbstractStructBase
{
     ...
     * Set DayOfWeek value
     * @param string $dayOfWeek
     * @return \OtaInterface\Otaconnect\StructType\EarliestPickup
     */
