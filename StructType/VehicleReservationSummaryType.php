...
class VehicleReservationSummaryType extends AbstractStructBase
{
     ...
     * @param \OtaInterface\Otaconnect\StructType\ConfID[] $confID
     * @return \OtaInterface\Otaconnect\StructType\VehicleReservationSummaryType
     */
    public function setConfID(array $confID = array())
    {
        foreach ($confID as $vehicleReservationSummaryTypeConfIDItem) {
            // validation for constraint: itemType
            if (!$vehicleReservationSummaryTypeConfIDItem instanceof \OtaInterface\Otaconnect\StructType\ConfID) {
                throw new \InvalidArgumentException(sprintf('The ConfID property can only contain items of \OtaInterface\Otaconnect\StructType\ConfID, "%s" given', is_object($vehicleReservationSummaryTypeConfIDItem) ? get_class($vehicleReservationSummaryTypeConfIDItem) : gettype($vehicleReservationSummaryTypeConfIDItem)), __LINE__);
            }
        }
        $this->ConfID = $confID;
        return $this;
