...
class OrdersType extends AbstractStructBase
{
     ...
     * - maxOccurs: 99
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\Order[]
     */
    public $Order;
    /**
     * The OrderType
     ...
     * @param \OtaInterface\Otaconnect\StructType\Order[] $order
    ...
    /**
     * Get Order value
     * @return \OtaInterface\Otaconnect\StructType\Order[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\Order[] $order
     * @return \OtaInterface\Otaconnect\StructType\OrdersType
     */
    public function setOrder(array $order = array())
    {
        foreach ($order as $ordersTypeOrderItem) {
            // validation for constraint: itemType
            if (!$ordersTypeOrderItem instanceof \OtaInterface\Otaconnect\StructType\Order) {
                throw new \InvalidArgumentException(sprintf('The Order property can only contain items of \OtaInterface\Otaconnect\StructType\Order, "%s" given', is_object($ordersTypeOrderItem) ? get_class($ordersTypeOrderItem) : gettype($ordersTypeOrderItem)), __LINE__);
            }
        }
        $this->Order = $order;
        return $this;
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\Order $item
     * @return \OtaInterface\Otaconnect\StructType\OrdersType
     */
    public function addToOrder(\OtaInterface\Otaconnect\StructType\Order $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\Order) {
            throw new \InvalidArgumentException(sprintf('The Order property can only contain items of \OtaInterface\Otaconnect\StructType\Order, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Order[] = $item;
        return $this;
    }
