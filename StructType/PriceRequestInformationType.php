...
class PriceRequestInformationType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\NegotiatedFareCode[]
     */
     ...
     * - maxOccurs: 99
     * - minOccurs: 0
     * @var \OtaInterface\Otaconnect\StructType\RebookOption[]
     */
    public $RebookOption;
    /**
     * The CabinType
     ...
     * @param \OtaInterface\Otaconnect\StructType\NegotiatedFareCode[] $negotiatedFareCode
     * @param \OtaInterface\Otaconnect\StructType\RebookOption[] $rebookOption
     ...
     * @return \OtaInterface\Otaconnect\StructType\NegotiatedFareCode[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\NegotiatedFareCode[] $negotiatedFareCode
     * @return \OtaInterface\Otaconnect\StructType\PriceRequestInformationType
     */
    public function setNegotiatedFareCode(array $negotiatedFareCode = array())
    {
        foreach ($negotiatedFareCode as $priceRequestInformationTypeNegotiatedFareCodeItem) {
            ...
            if (!$priceRequestInformationTypeNegotiatedFareCodeItem instanceof \OtaInterface\Otaconnect\StructType\NegotiatedFareCode) {
                throw new \InvalidArgumentException(sprintf('The NegotiatedFareCode property can only contain items of \OtaInterface\Otaconnect\StructType\NegotiatedFareCode, "%s" given', is_object($priceRequestInformationTypeNegotiatedFareCodeItem) ? get_class($priceRequestInformationTypeNegotiatedFareCodeItem) : gettype($priceRequestInformationTypeNegotiatedFareCodeItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\NegotiatedFareCode $item
     * @return \OtaInterface\Otaconnect\StructType\PriceRequestInformationType
     */
    public function addToNegotiatedFareCode(\OtaInterface\Otaconnect\StructType\NegotiatedFareCode $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\NegotiatedFareCode) {
            throw new \InvalidArgumentException(sprintf('The NegotiatedFareCode property can only contain items of \OtaInterface\Otaconnect\StructType\NegotiatedFareCode, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \OtaInterface\Otaconnect\StructType\RebookOption[]|null
     */
    ...
    public function setRebookOption(array $rebookOption = array())
    {
        foreach ($rebookOption as $priceRequestInformationTypeRebookOptionItem) {
            // validation for constraint: itemType
            if (!$priceRequestInformationTypeRebookOptionItem instanceof \OtaInterface\Otaconnect\StructType\RebookOption) {
                throw new \InvalidArgumentException(sprintf('The RebookOption property can only contain items of \OtaInterface\Otaconnect\StructType\RebookOption, "%s" given', is_object($priceRequestInformationTypeRebookOptionItem) ? get_class($priceRequestInformationTypeRebookOptionItem) : gettype($priceRequestInformationTypeRebookOptionItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\RebookOption $item
     * @return \OtaInterface\Otaconnect\StructType\PriceRequestInformationType
     */
    public function addToRebookOption(\OtaInterface\Otaconnect\StructType\RebookOption $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\RebookOption) {
            throw new \InvalidArgumentException(sprintf('The RebookOption property can only contain items of \OtaInterface\Otaconnect\StructType\RebookOption, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
