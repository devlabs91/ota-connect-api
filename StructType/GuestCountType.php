...
class GuestCountType extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - maxOccurs: 99
     * @var \OtaInterface\Otaconnect\StructType\GuestCount[]
     */
    public $GuestCount;
    /**
     * The IsPerRoom
     ...
     * @param \OtaInterface\Otaconnect\StructType\GuestCount[] $guestCount
     ...
     * @return \OtaInterface\Otaconnect\StructType\GuestCount[]|null
     */
     ...
     * @param \OtaInterface\Otaconnect\StructType\GuestCount[] $guestCount
     * @return \OtaInterface\Otaconnect\StructType\GuestCountType
     */
    public function setGuestCount(array $guestCount = array())
    {
        foreach ($guestCount as $guestCountTypeGuestCountItem) {
            // validation for constraint: itemType
            if (!$guestCountTypeGuestCountItem instanceof \OtaInterface\Otaconnect\StructType\GuestCount) {
                throw new \InvalidArgumentException(sprintf('The GuestCount property can only contain items of \OtaInterface\Otaconnect\StructType\GuestCount, "%s" given', is_object($guestCountTypeGuestCountItem) ? get_class($guestCountTypeGuestCountItem) : gettype($guestCountTypeGuestCountItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \OtaInterface\Otaconnect\StructType\GuestCount $item
     * @return \OtaInterface\Otaconnect\StructType\GuestCountType
     */
    public function addToGuestCount(\OtaInterface\Otaconnect\StructType\GuestCount $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \OtaInterface\Otaconnect\StructType\GuestCount) {
            throw new \InvalidArgumentException(sprintf('The GuestCount property can only contain items of \OtaInterface\Otaconnect\StructType\GuestCount, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
